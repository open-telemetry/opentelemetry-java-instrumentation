...
readonly INSTRUMENTATIONS=(
  ...
  "micrometer:micrometer-1.5:javaagent:test"
  "micrometer:micrometer-1.5:javaagent:testPrometheusMode"
  "micrometer:micrometer-1.5:javaagent:testBaseTimeUnit"
  "micrometer:micrometer-1.5:javaagent:testHistogramGauges"
