...
readonly INSTRUMENTATIONS=(
  ...
  "spring:spring-cloud-gcp-5.0:javaagent:test"
  "spring:spring-cloud-gcp-5.0:javaagent:testMessagingPreview"
  "spring:spring-cloud-gcp-5.0:javaagent:testBothSemconv"
