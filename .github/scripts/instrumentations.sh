...
readonly INSTRUMENTATIONS=(
  ...
  "instrumentation:ibmmq:ibmmq-9.0:javaagent:test"
  "instrumentation:ibmmq:ibmmq-9.0:javaagent:testExperimental"
  "instrumentation:ibmmq:ibmmq-9.3:javaagent:test"
  "instrumentation:ibmmq:ibmmq-9.3:javaagent:testExperimental"
