...
readonly INSTRUMENTATIONS=(
  ...
  "apache-httpclient:apache-httpclient-4.3:library:testStableSemconv"
  ...
  "apache-httpclient:apache-httpclient-5.2:library:testStableSemconv"
  ...
  "aws-sdk:aws-sdk-2.2:javaagent:testExperimentalSqs"
  ...
  "finagle-http-23.11:javaagent:testStableSemconv"
  ...
  "hibernate:hibernate-3.3:javaagent:testStableSemconv"
  ...
  "hibernate:hibernate-6.0:javaagent:hibernate6TestStableSemconv"
  "hibernate:hibernate-procedure-call-4.3:javaagent:test"
  "hibernate:hibernate-procedure-call-4.3:javaagent:testExperimental"
  "hibernate:hibernate-procedure-call-4.3:javaagent:testStableSemconv"
  ...
  "play:play-mvc:play-mvc-2.4:javaagent:testStableSemconv"
  ...
  "ratpack:ratpack-1.7:library:testStableSemconv"
  ...
  "reactor:reactor-netty:reactor-netty-0.9:javaagent:testStableSemconv"
  ...
  "sofa-rpc-5.4:javaagent:testStableSemconv"
  ...
  "spring:spring-scheduling-3.1:javaagent:testStableSemconv"
