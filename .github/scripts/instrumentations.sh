...
readonly INSTRUMENTATIONS=(
  ...
  "aws-lambda:aws-lambda-core-1.0:javaagent:testExceptionSignalLogs"
  ...
  "couchbase:couchbase-2.0:javaagent:library26Test"
  "couchbase:couchbase-2.0:javaagent:library26TestExperimental"
  "couchbase:couchbase-2.0:javaagent:library26TestLegacyConfig"
  "couchbase:couchbase-2.0:javaagent:library26TestStableSemconv"
  ...
  "hbase:hbase-client-2.0:javaagent:testExceptionSignalLogs"
  ...
  "jdbc:javaagent:testExceptionSignalLogs"
  ...
  "kafka:kafka-clients:kafka-clients-2.6:library:testExceptionSignalLogs"
  ...
  "openai:openai-java-1.1:javaagent:testExceptionSignalLogs"
  ...
  "spring:spring-webflux:spring-webflux-5.0:javaagent:testExceptionSignalLogs"
  ...
  "undertow-1.4:javaagent:testExceptionSignalLogs"
  ...
  "vertx:vertx-redis-client:vertx-redis-client-4.0:javaagent:test"
  "vertx:vertx-redis-client:vertx-redis-client-4.0:javaagent:test403"
  "vertx:vertx-redis-client:vertx-redis-client-4.0:javaagent:test403StableSemconv"
  "vertx:vertx-redis-client:vertx-redis-client-4.0:javaagent:test445"
  "vertx:vertx-redis-client:vertx-redis-client-4.0:javaagent:test445StableSemconv"
  "vertx:vertx-redis-client:vertx-redis-client-4.0:javaagent:testStableSemconv"
