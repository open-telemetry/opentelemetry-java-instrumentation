...
| Performance  | Precompile production Java regular-expression literals in reusable `static final Pattern` fields, including on cold paths                                                                                                                                                                                                                                                                                     | Production Java regex literals passed to `String.replaceAll`, `String.matches`, `String.split`, or similar APIs                                                 | —                                  |
...
Flag production Java regular-expression literals passed directly to APIs such as
`String.replaceAll`, `String.matches`, or `String.split`. Require them to be precompiled in
reusable `static final Pattern` fields, even during startup, client initialization, registration,
or another cold path. Do not apply this rule to test code.
