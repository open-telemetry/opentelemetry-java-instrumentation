...
| Semconv      | Treat `SHOULD` and `RECOMMENDED` as compelling guidance; flag an unexplained changed-line deviation when the implementation can comply, while distinguishing it from strict `MUST` noncompliance                                                                                                                                                                                                              | Changes implementing or emitting telemetry governed by semantic conventions; explicit conformance review                                                        | `semconv-conformance.md`           |
