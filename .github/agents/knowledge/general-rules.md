...
| Performance  | Precompile production Java regular-expression literals in reusable `static final Pattern` fields, including on cold paths                                                                                                                                                                                                                                                                                     | Production Java regex literals passed to `String.replaceAll`, `String.matches`, or similar APIs; `String.split` outside the JDK fast path                       | —                                  |
...
`String.replaceAll` or `String.matches`. Require them to be precompiled in reusable
