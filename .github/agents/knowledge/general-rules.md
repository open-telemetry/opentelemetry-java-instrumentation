...
| Semconv      | Verify the complete applicable semantic convention, including telemetry shape, requirement levels, value rules, cardinality/privacy, stability, and compelling `SHOULD`/`RECOMMENDED` guidance                                                                                                                                                                                                                | Changes implementing or emitting telemetry governed by semantic conventions; explicit conformance review                                                        | `semconv-conformance.md`           |
