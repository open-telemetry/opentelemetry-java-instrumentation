...
| `messaging-telemetry-ownership.md` | Overlapping messaging observers; processing selection or invocation naming, framework/client handoff, copied carriers, nested callbacks, scoped suppression, fallback, or best-effort Kafka/SQS traversal   |
