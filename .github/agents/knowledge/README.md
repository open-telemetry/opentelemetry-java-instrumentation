...
| `javaagent-locking.md`             | Synchronization around shared javaagent instrumentation state; private lock ownership, bounded critical sections, and external calls or callbacks near locks                                                |
