...
| `gradle-conventions.md`            | `build.gradle.kts` or `settings.gradle.kts` changes, `javaagent-unit-tests` setup, custom test task registration or wiring                                                                             |
...
| `module-naming.md`                 | New or renamed modules or packages, including `javaagent-unit-tests`; settings includes                                                                                                                |
...
| `testing-general-patterns.md`      | Test files in scope — test-module placement, assertion style, test method signatures and throws clauses, resource cleanup patterns, abstract test base class state shape, attribute assertion patterns |
