...
| `messaging-telemetry-ownership.md` | Overlapping messaging observers; processing ownership, parent context, nested callbacks, completion, framework delegation, fallback, or best-effort Kafka/SQS traversal                                     |
