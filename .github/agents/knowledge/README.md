...
| `messaging-telemetry-ownership.md` | Overlapping messaging observers; process-span ownership, framework/client handoff, copied carriers, nested callbacks, scoped suppression, fallback, or best-effort Kafka/SQS traversal                      |
