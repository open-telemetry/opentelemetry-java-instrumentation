...
| `javaagent-locking.md`             | Synchronization around shared instrumentation state in javaagent or library instrumentation; ownership, bounded critical sections, publication, and external calls near locks                               |
