...
class SpanAssert {
    ...
    static void assertSpan(SpanData span,
                           @ClosureParams(value = SimpleType, options = ['io.opentelemetry.auto.agent.test.asserts.SpanAssert'])
    ...
    void tags(@ClosureParams(value = SimpleType, options = ['io.opentelemetry.auto.agent.test.asserts.AttributesAssert'])
