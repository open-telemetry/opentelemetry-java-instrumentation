...
import static io.opentelemetry.auto.agent.tooling.ByteBuddyElementMatchers.failSafe;
import static net.bytebuddy.matcher.ElementMatchers.any;

import io.opentelemetry.auto.agent.tooling.context.FieldBackedProvider;
import io.opentelemetry.auto.agent.tooling.context.InstrumentationContextProvider;
...
public interface Instrumenter {
  ...
  abstract class Default implements Instrumenter {
     ...
     *
     * <p>{@see io.opentelemetry.auto.agent.tooling.muzzle.MuzzleGradlePlugin}
     */
