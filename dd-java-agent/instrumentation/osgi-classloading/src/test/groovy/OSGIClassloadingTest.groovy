...
class OSGIClassloadingTest extends AgentTestRunner {
  ...
  static final String BOOT_DELEGATION_ADDITION = "datadog.slf4j.*,datadog.slf4j,datadog.trace.api.*,datadog.trace.api,datadog.trace.bootstrap.*,datadog.trace.bootstrap,datadog.trace.instrumentation.api.*,datadog.trace.instrumentation.api"
