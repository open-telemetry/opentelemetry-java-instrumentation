...
/**
 * Reads OpenTelemetry configuration from JVM system properties, falling back to the corresponding
 * environment variables.
 *
 * <p>For library instrumentation, prefer programmatic configuration. Direct property lookup is
 * needed only when a programmatic configuration surface cannot be exposed. Once declarative
 * instrumentation configuration is stable, use it instead. Current examples include library
 * instrumentation entry points loaded through an SPI, driver, or similar mechanism.
 *
