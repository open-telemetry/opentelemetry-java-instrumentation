...
public class GlobalIgnoresMatcher<T extends TypeDescription>
  ...
  public boolean matches(final T target) {
    ...
    if (name.startsWith("io.opentelemetry.auto.")) {
      ...
      if (name.equals("io.opentelemetry.instrumentation.api.concurrent.RunnableWrapper")
          || name.equals("io.opentelemetry.instrumentation.api.concurrent.CallableWrapper")) {
        return false;
      }
      return true;
    }
