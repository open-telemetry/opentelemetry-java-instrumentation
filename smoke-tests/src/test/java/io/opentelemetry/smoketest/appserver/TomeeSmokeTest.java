...
abstract class TomeeSmokeTest extends AppServerTest {
  ...
  @AppServer(version = "7.0.9", jdk = "8-openj9", reduced = true)
  ...
  @AppServer(version = "7.1.4", jdk = "8-openj9", reduced = true)
  ...
  @AppServer(version = "8.0.16", jdk = "8-openj9", reduced = true)
  ...
  @AppServer(version = "8.0.16", jdk = "11-openj9", reduced = true)
  ...
  @AppServer(version = "8.0.16", jdk = "17-openj9", reduced = true)
  ...
  @AppServer(version = "8.0.16", jdk = "21-openj9", reduced = true)
  ...
  @AppServer(version = "8.0.16", jdk = "25-openj9", reduced = true)
  ...
  @AppServer(version = "9.1.3", jdk = "11-openj9", reduced = true)
  ...
  @AppServer(version = "9.1.3", jdk = "17-openj9", reduced = true)
  ...
  @AppServer(version = "9.1.3", jdk = "21-openj9", reduced = true)
  ...
  @AppServer(version = "9.1.3", jdk = "25-openj9", reduced = true)
