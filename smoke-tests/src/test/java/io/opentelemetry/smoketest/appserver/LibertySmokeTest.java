...
abstract class LibertySmokeTest extends AppServerTest {
  ...
  @AppServer(version = "20.0.0.12", jdk = "8", reduced = true)
  ...
  @AppServer(version = "21.0.0.12", jdk = "8", reduced = true)
  ...
  @AppServer(version = "22.0.0.12", jdk = "8", reduced = true)
  ...
  @AppServer(version = "23.0.0.12", jdk = "8", reduced = true)
  ...
  @AppServer(version = "26.0.0.3", jdk = "8", reduced = true)
