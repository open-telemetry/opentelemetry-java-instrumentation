...
abstract class WildflySmokeTest extends AppServerTest {
  ...
  @AppServer(version = "13.0.0.Final", jdk = "8", reduced = true)
  ...
  @AppServer(version = "17.0.1.Final", jdk = "8", reduced = true)
  ...
  @AppServer(version = "21.0.0.Final", jdk = "8", reduced = true)
  ...
  @AppServer(version = "28.0.1.Final", jdk = "11", reduced = true)
  ...
  @AppServer(version = "29.0.1.Final", jdk = "11", reduced = true)
  ...
  @AppServer(version = "30.0.1.Final", jdk = "11", reduced = true)
