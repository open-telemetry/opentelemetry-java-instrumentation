...
plugins {
  ...
  id("io.quarkus") version "3.14.4" // 3.15.x has a transitive dependency resolution issue
}

dependencies {
  implementation(enforcedPlatform("io.quarkus:quarkus-bom:3.14.4")) // 3.15.x has a transitive dependency resolution issue
