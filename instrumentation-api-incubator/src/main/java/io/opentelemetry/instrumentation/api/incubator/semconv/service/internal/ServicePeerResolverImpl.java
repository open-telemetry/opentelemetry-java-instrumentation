...
package io.opentelemetry.instrumentation.api.incubator.semconv.service.internal;
 ...
 * any time.
 */
public class ServicePeerResolverImpl implements ServicePeerResolver {
  ...
  public ServicePeerResolverImpl(Map<String, String> peerServiceMapping) {
  ...
  abstract static class ServiceMatcher {
    ...
    static ServiceMatcher create(@Nullable Integer port, @Nullable String path) {
      return new AutoValue_ServicePeerResolverImpl_ServiceMatcher(port, path);
    }
