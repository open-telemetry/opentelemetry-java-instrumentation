...
public class ContextPropagationOperator {
  ...
  @Nullable
  protected static final MethodHandle MONO_CONTEXT_WRITE_METHOD = getContextWriteMethod(Mono.class);

  @Nullable
  protected static final MethodHandle FLUX_CONTEXT_WRITE_METHOD = getContextWriteMethod(Flux.class);

  @Nullable protected static final MethodHandle SCHEDULERS_HOOK_METHOD = getSchedulersHookMethod();
  ...
  protected static final Object TRACE_CONTEXT_KEY =
      new Object() {
        @Override
  ...
  /**
   * Gets Trace {@link Context} from Reactor {@link reactor.util.context.Context}.
   *
  ...
  public static ContextPropagationOperator create() {
    return new ContextPropagationOperatorBuilder().build();
  }
  ...
  protected static class ScalarPropagatingMono extends Mono<Object> implements Scannable {

    public static <T> Mono<T> create(Mono<T> source) {
  ...
  protected static class ScalarPropagatingFlux extends Flux<Object> implements Scannable {

    public static <T> Flux<T> create(Flux<T> source) {
