...
class McpServerRequestInstrumentationTest {
                ...
                span ->
                    span.hasName("tools/call delete-file")
                        ...
                        .hasAttributesSatisfyingExactly(
                            ...
                            equalTo(MCP_PROTOCOL_VERSION, ProtocolVersions.MCP_2024_11_05))),
        trace -> trace.hasSpansSatisfyingExactly(span -> span.hasName("transport").hasNoParent()));
    testing.waitAndAssertMetrics(
        "io.opentelemetry.mcp-java-sdk-0.14",
        metric ->
            metric
                .hasName("mcp.server.operation.duration")
                .hasUnit("s")
                .hasDescription(MCP_SERVER_OPERATION_DURATION_DESCRIPTION)
                        ...
                        histogram.hasPointsSatisfying(
                            point ->
                                point
                                    ...
                                    .hasBucketBoundaries(
                                        0.01, 0.02, 0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10, 30, 60, 120,
                                        300))));
  }
  ...
  void tracesStreamableToolResultError() {
    ...
    assertThat(sessionInit.initResult().block()).isEqualTo(INITIALIZE_RESULT);
                ...
                span ->
                    span.hasName("tools/call failing-tool")
                        ...
                        .hasAttributesSatisfyingExactly(
                            ...
                            equalTo(MCP_SESSION_ID, session.getId()),
                            equalTo(MCP_PROTOCOL_VERSION, ProtocolVersions.MCP_2024_11_05),
