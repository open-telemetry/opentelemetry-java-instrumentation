...
public final class McpServerToolCallState {
  private static final Logger logger = Logger.getLogger(McpServerToolCallState.class.getName());
  ...
  public static McpServerToolCallState prepare(
    ...
    try {
      ...
      logger.log(FINE, "Failed to prepare MCP server tool call instrumentation", t);
      return null;
    }
  }
