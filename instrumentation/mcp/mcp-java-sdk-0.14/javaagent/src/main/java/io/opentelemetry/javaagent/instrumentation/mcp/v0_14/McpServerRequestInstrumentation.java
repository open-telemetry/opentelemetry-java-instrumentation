...
class McpServerRequestInstrumentation implements TypeInstrumentation {
  ...
  public static class StatefulRequestAdvice {
    ...
    public static McpServerToolCallState onEnter(
      ...
      return McpServerToolCallState.prepare(
          request, session.getId(), McpProtocolVersionState.get(session));
    }
    ...
    public static Mono<?> onExit(
      ...
      Mono<?> result = state == null ? publisher : state.finish(publisher);
      return McpProtocolVersionState.capture(session, request.method(), result);
    }
  }
  ...
  public static class StreamableRequestAdvice {
    ...
    public static Object[] onEnter(
      ...
      McpServerToolCallState state =
          McpServerToolCallState.prepare(
              request, session.getId(), McpProtocolVersionState.get(session));
  ...
  public static class StatelessRequestAdvice {
    ...
    public static McpServerToolCallState onEnter(
      ...
      return McpServerToolCallState.prepare(request, null, null);
    }
