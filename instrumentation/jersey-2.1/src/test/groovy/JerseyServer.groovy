...
import static io.opentelemetry.auto.test.base.HttpServerTest.controller

class JerseyServer {
  static HttpServer startServer(int port) {
    ResourceConfig rc = new ResourceConfig()
    rc.register(SimpleExceptionMapper)
    rc.register(ServiceResource)
    return GrizzlyHttpServerFactory.createHttpServer(new URI("http://localhost:$port"), rc)
  }
