...
/**
 * A {@link WebFilter} that captures identity semantic attributes from the {@link
 ...
 *
 * <p>Inserted into the filter chain by {@link UserAttributesServerHttpSecurityCustomizer} after all
 ...
 */
public class UserAttributesCapturingWebFilter implements WebFilter {

  private final UserAttributesCapturer capturer;

  public UserAttributesCapturingWebFilter(UserAttributesCapturer capturer) {
