...
/**
 * Customizes a {@link HttpSecurity} by inserting a {@link UserAttributesCapturingServletFilter}
 ...
 */
public class UserAttributesHttpSecurityCustomizer implements Customizer<HttpSecurity> {

  private final UserAttributesCapturer capturer;

  public UserAttributesHttpSecurityCustomizer(UserAttributesCapturer capturer) {
  ...
  public void customize(HttpSecurity httpSecurity) {
    ...
    httpSecurity.addFilterBefore(
        new UserAttributesCapturingServletFilter(capturer), AuthorizationFilter.class);
  }
}
