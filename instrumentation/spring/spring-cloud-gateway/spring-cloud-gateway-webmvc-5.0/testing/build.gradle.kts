...
dependencies {
  testInstrumentation(project(":instrumentation:spring:spring-cloud-gateway:spring-cloud-gateway-webmvc-5.0:javaagent"))

  // WebMVC instrumentations
  ...
  // Spring Cloud Gateway 5.0 WebMVC variant
