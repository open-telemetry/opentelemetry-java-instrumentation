...
For documentation on Spring autoconfiguration, see [THIS LINK IS INVALID - HASH DOES NOT EXIST](https://opentelemetry.io/docs/zero-code/java/spring-boot/#automatic-instrumentation).
