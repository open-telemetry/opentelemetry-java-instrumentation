 ...
 *
 * <p>Sets default value of otel.instrumentation.httpclients.enabled to true if the configuration
 * does not exist in application context.
 */
@ConfigurationProperties(prefix = "otel.instrumentation.httpclients")
