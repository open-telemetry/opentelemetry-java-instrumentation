...
public final class SpringAwsSqsSingletons {
  ...
  private static final SpringAwsSqsBatchProcessAttributesGetter batchAttributesGetter =
  ...
  private static final Instrumenter<Collection<Message<?>>, Void> batchProcessInstrumenter;

  static {
    InstrumenterBuilder<Collection<Message<?>>, Void> builder =
        ...
        builder
            .addAttributesExtractor(
                MessagingAttributesExtractor.builder(
                        batchAttributesGetter, MessageOperation.PROCESS)
