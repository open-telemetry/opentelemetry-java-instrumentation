...
public final class SpringWebMvcTelemetryBuilder {
  ...
  SpringWebMvcTelemetryBuilder(OpenTelemetry openTelemetry) {
    builder =
        DefaultHttpServerInstrumenterBuilder.create(
            ...
            new JavaxHttpServletRequestGetter());
  }
   ...
   */
  @CanIgnoreReturnValue
  public SpringWebMvcTelemetryBuilder setRequestHeaders(IncludeExclude requestHeaders) {
   ...
   */
  @CanIgnoreReturnValue
  public SpringWebMvcTelemetryBuilder setResponseHeaders(IncludeExclude responseHeaders) {
