...
import io.opentelemetry.instrumentation.runtimetelemetryjfr.internal.Constants;
...
public final class YoungGarbageCollectionHandler implements RecordedEventHandler {
  ...
  public YoungGarbageCollectionHandler(Meter meter, String gc) {
    ...
    attributes =
        Attributes.of(Constants.ATTR_GC, gc, Constants.ATTR_ACTION, Constants.END_OF_MINOR_GC);
  }
