...
plugins {
  ...
  id("io.opentelemetry.instrumentation.quarkus-3.0") apply false
}
...
dependencies {
  ...
  testInstrumentation(project(":instrumentation:quarkus-resteasy-reactive-1.11:javaagent"))
  testInstrumentation(project(":instrumentation:vertx:vertx-web-3.0:javaagent"))

  testImplementation(project(":instrumentation:quarkus-resteasy-reactive-1.11:quarkus-common-testing"))
