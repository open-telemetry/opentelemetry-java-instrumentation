...
/**
 * Tests for capture-search-query=true with JsonbJsonpMapper. This test verifies that the
 * SanitizingJsonGenerator fallback path (non-Jackson mapper) correctly sanitizes query bodies.
 */
@SuppressWarnings("deprecation") // using deprecated semconv
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class OpenSearchCaptureSearchQueryJsonbTest {

  private static final String INDEX_NAME = "test-search-jsonb-index";
  ...
  private OpenSearchClient buildOpenSearchClient() throws Exception {
    ...
    OpenSearchTransport transport = new RestClientTransport(restClient, new JsonbJsonpMapper());
