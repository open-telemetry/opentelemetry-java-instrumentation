...
public class RestClientInstrumentation implements TypeInstrumentation {
  ...
  public static class PerformRequestAdvice {
    ...
    public static void onEnter(
      ...
      if (!OpenSearchRest2Singletons.instrumenter().shouldStart(parentContext, otelRequest)) {
        return;
      }

      context = OpenSearchRest2Singletons.instrumenter().start(parentContext, otelRequest);
    ...
    public static void stopSpan(
      ...
      OpenSearchRest2Singletons.instrumenter().end(context, otelRequest, response, throwable);
    }
  }
  ...
  public static class PerformRequestAsyncAdvice {
    ...
    public static void onEnter(
      ...
      responseListener =
          new RestResponseListener(
              responseListener,
              parentContext,
              OpenSearchRest2Singletons.instrumenter(),
              context,
              otelRequest);
    }
    ...
    public static void stopSpan(
      ...
      if (throwable != null) {
        OpenSearchRest2Singletons.instrumenter().end(context, otelRequest, null, throwable);
      }
