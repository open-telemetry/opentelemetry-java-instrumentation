...
import io.opentelemetry.javaagent.instrumentation.elasticsearch.transport.ElasticTransportNetworkAttributeGetter;
...
public final class Elasticsearch5TransportSingletons {
  ...
  private static final Instrumenter<ElasticTransportRequest, ActionResponse> INSTRUMENTER =
      ElasticsearchTransportInstrumenterFactory.create(
          ...
          NetworkAttributesExtractor.create(new ElasticTransportNetworkAttributeGetter()));
