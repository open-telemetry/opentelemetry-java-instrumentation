 ...
 * any time.
 */
final class ElasticsearchDbAttributeGetter
    implements DbClientAttributeGetter<ElasticsearchRestRequest> {

  private static final Logger logger =
      Logger.getLogger(ElasticsearchDbAttributeGetter.class.getName());

  private final boolean captureSearchQuery;

  ElasticsearchDbAttributeGetter(boolean captureSearchQuery) {
