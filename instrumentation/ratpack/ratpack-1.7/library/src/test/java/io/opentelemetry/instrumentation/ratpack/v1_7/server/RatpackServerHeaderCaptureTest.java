...
class RatpackServerHeaderCaptureTest {
  ...
  @Test
  void capturesEnumeratedHeadersWhenOnlyExcludingHeaders() throws Exception {
  ...
  @SuppressWarnings("deprecation") // testing deprecated API
  @Test
  void doesNotTreatConfiguredNamesAsPatterns() throws Exception {
    RatpackServerTelemetry telemetry =
        RatpackServerTelemetry.builder(testing.getOpenTelemetry())
