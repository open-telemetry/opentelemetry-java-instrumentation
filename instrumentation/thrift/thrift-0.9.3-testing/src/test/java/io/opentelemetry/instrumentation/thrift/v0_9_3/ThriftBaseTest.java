...
import io.opentelemetry.instrumentation.thrift.v0_9_3.server.ThriftServiceAsyncImpl;
import io.opentelemetry.instrumentation.thrift.v0_9_3.server.ThriftServiceImpl;
...
public abstract class ThriftBaseTest {
  ...
  private static final String ASYNC_CLIENT =
      "io.opentelemetry.instrumentation.thrift.v0_9_3.thrift.ThriftService$AsyncClient";
  private static final String SYNC_CLIENT =
      "io.opentelemetry.instrumentation.thrift.v0_9_3.thrift.ThriftService$Client";
  private static final String ASYNC_SERVER =
      "io.opentelemetry.instrumentation.thrift.v0_9_3.server.ThriftServiceAsyncImpl";
  private static final String SYNC_SERVER =
      "io.opentelemetry.instrumentation.thrift.v0_9_3.server.ThriftServiceImpl";
  ...
  public void startMultiSyncHsHaServer(int port) throws TTransportException {
    ThriftServiceImpl syncImpl = new ThriftServiceImpl();
    ThriftService.Processor<ThriftServiceImpl> syncProcessor =
        new ThriftService.Processor<ThriftServiceImpl>(syncImpl);
    ThriftServiceAsyncImpl asyncImpl = new ThriftServiceAsyncImpl();
  ...
  public void waitAndAssertTracesClientSyncServerSyncWithError(
    ...
    this.baseWaitAndAssertTraces(
        ...
        PEER_NAME,
        PEER_ADDR,
        val -> val.isIn(null, "Internal error processing " + clientMethod),
        TRANSPORT_EXCEPTION,
        SYNC_SERVER,
        StatusData.error(),
        val -> val.isIn("fail"),
  ...
  public void waitAndAssertTracesClientAsyncServerSync(
      String clientMethod, String serverMethod, int count) {
    this.baseWaitAndAssertTraces(
        clientMethod,
        serverMethod,
  ...
  public void waitAndAssertTracesClientAsyncServerSyncWithError(
    ...
    this.baseWaitAndAssertTraces(
        ...
        PEER_NAME,
        PEER_ADDR,
        val -> val.isIn("Read call frame size failed", "Internal error processing " + clientMethod),
        IO_EXCEPTION,
        SYNC_SERVER,
        StatusData.error(),
        val -> val.isIn("fail"),
