...
import io.opentelemetry.javaagent.instrumentation.thrift.internal.ThriftNetClientAttributesGetter;
...
public final class ThriftSingletons {
  ...
  static {
    ThriftNetClientAttributesGetter thriftNetClientAttributesGetter = new ThriftNetClientAttributesGetter();
    ThriftNetServerAttributesGetter thriftNetServerAttributesGetter = new ThriftNetServerAttributesGetter();
    ...
    CLIENT_INSTRUMENTER = Instrumenter.<ThriftRequest, Integer>builder(
            GlobalOpenTelemetry.get(), INSTRUMENTATION_NAME, spanNameExtractor).addAttributesExtractor(new ThriftAttributesExtractor())
        .addAttributesExtractor(RpcClientAttributesExtractor.create(thriftRpcAttributesGetter))
        .addAttributesExtractor(
            NetClientAttributesExtractor.create(thriftNetClientAttributesGetter)).buildClientInstrumenter(ThriftHeaderSetter.INSTANCE);
    SERVER_INSTRUMENTER = Instrumenter.<ThriftRequest, Integer>builder(
            GlobalOpenTelemetry.get(), INSTRUMENTATION_NAME, spanNameExtractor)
        .addAttributesExtractor(RpcServerAttributesExtractor.create(thriftRpcAttributesGetter))
        .addAttributesExtractor(
            NetServerAttributesExtractor.create(thriftNetServerAttributesGetter)).buildServerInstrumenter(ThriftHeaderGetter.INSTANCE);
  }
