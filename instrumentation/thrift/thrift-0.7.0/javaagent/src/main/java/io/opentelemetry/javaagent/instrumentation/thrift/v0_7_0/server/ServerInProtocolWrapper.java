...
import io.opentelemetry.javaagent.instrumentation.thrift.v0_7_0.AbstractProtocolWrapper;
...
public final class ServerInProtocolWrapper extends AbstractProtocolWrapper {
  ...
  public static final ThreadLocal<TTransport> CONTEXT_THREAD_LOCAL = new ThreadLocal<>();
  ...
  public TField readFieldBegin() throws TException {
    ...
    if (field.id == OT_MAGIC_FIELD_ID && field.type == TType.MAP) {
      try {
        ...
        if (socket == null) {
          TTransport transport = CONTEXT_THREAD_LOCAL.get();
