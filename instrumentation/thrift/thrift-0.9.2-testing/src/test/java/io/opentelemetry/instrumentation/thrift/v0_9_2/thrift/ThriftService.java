...
package io.opentelemetry.instrumentation.thrift.v0_9_2.thrift;
...
public class ThriftService {
  ...
  public static class withDelay_args
    ...
    public int hashCode() {
      ...
      if (present_delay) list.add(delay);
  ...
  public static class withCollisioin_args
    ...
    public int hashCode() {
      ...
      if (present_input) list.add(input);
