...
public class OneWayTest extends ThriftBaseTest {
  ...
  @Test
  public void syncNonblockingSaslClientSyncSaslNonblockingServerOneWayError() {
    Exception error = null;
    try {
      this.startSyncSaslNonblockingServer(this.port);
      this.syncNonblockingSaslClientOneWay(this.port);
    } catch (IOException | TException e) {
      error = e;
    }
    Assertions.assertThat(error).isNull();
    this.waitAndAssertTracesClientSyncNoServerNoSasl("oneWay", 1);
  }

  @Test
  public void syncNonblockingSaslClientAsyncSaslNonblockingServerOneWayError() {
    Exception error = null;
    try {
  ...
  public void syncNonblockingSaslClientOneWay(int port) throws TException, IOException {
