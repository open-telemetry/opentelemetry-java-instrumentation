...
public abstract class ThriftBaseTest {
  ...
  private static final String VERIFY_EXCEPTION = "org.apache.thrift.transport.TTransportException";
  ...
  protected void runParallel(int threadCount, CheckedRunnable action) throws InterruptedException {
      ...
      new Thread(
              () -> {
                try {
                  ...
                  Assertions.fail("parallel test failed: " + e.getMessage());
                } finally {
                  latch.countDown();
                }
              })
  ...
  public void startSyncSimpleServer(int port) throws TTransportException {
    ...
    new Thread(() -> this.server.serve()).start();
  }
                      ...
                      event ->
                          event
                              ...
                              .hasAttributesSatisfyingExactly(
                                  ...
                                  satisfies(
                                      stringKey("exception.stacktrace"), AbstractAssert::isNotNull),
