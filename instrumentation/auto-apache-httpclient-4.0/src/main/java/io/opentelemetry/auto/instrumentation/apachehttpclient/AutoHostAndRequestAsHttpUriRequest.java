...
@Getter
public class AutoHostAndRequestAsHttpUriRequest extends AbstractHttpMessage implements
  HttpUriRequest {
  ...
  public AutoHostAndRequestAsHttpUriRequest(final HttpHost httpHost, final HttpRequest httpRequest) {

    method = httpRequest.getRequestLine().getMethod();
    requestLine = httpRequest.getRequestLine();
    protocolVersion = requestLine.getProtocolVersion();

    java.net.URI calculatedURI;
    try {
