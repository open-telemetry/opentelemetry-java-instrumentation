...
public class CamundaEndEventActivityBehaviorModule extends InstrumentationModule {
	...
	String[] helperClassnames = { "com.att.sre.otel.javaagent.instrumentation.camunda.v7_18.behavior",
			"com.att.sre.otel.javaagent.instrumentation.camunda.v7_18.common" };
