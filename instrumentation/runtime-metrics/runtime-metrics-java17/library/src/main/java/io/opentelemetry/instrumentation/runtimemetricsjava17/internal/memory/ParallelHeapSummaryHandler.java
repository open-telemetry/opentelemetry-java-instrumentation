...
package io.opentelemetry.instrumentation.runtimemetricsjava17.internal.memory;

import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.ATTR_POOL;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.ATTR_TYPE;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.BYTES;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.COMMITTED_SIZE;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.HEAP;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.METRIC_DESCRIPTION_COMMITTED;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.METRIC_DESCRIPTION_MEMORY;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.METRIC_DESCRIPTION_MEMORY_AFTER;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.METRIC_DESCRIPTION_MEMORY_LIMIT;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.METRIC_NAME_COMMITTED;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.METRIC_NAME_MEMORY;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.METRIC_NAME_MEMORY_AFTER;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.METRIC_NAME_MEMORY_LIMIT;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.RESERVED_SIZE;
import static io.opentelemetry.instrumentation.runtimemetricsjava17.internal.Constants.USED;

import io.opentelemetry.api.common.Attributes;
import io.opentelemetry.api.metrics.Meter;
import io.opentelemetry.instrumentation.runtimemetricsjava17.JfrFeature;
