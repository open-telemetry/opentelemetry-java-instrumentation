...
public class Servlet5OutputStreamWriteBytesAndOffsetAdvice {
  @Advice.OnMethodEnter(skipOn = Advice.OnDefaultValue.class, suppress = Throwable.class, inline = false)
  public static boolean methodEnter(
    ...
    return !snippetInjectionHelper().handleWrite(state, servletOutputStream, write, off, len);
  }
}
