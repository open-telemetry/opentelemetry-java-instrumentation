...
import io.opentelemetry.javaagent.instrumentation.servlet.ServletHttpAttributeGetter;
...
public class Servlet2HttpAttributeGetter
    extends ServletHttpAttributeGetter<HttpServletRequest, HttpServletResponse> {

  public Servlet2HttpAttributeGetter(
