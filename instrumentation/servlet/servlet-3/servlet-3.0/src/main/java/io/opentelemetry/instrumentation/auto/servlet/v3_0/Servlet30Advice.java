...
import static io.opentelemetry.instrumentation.auto.servlet.v3.Servlet3HttpServerTracer.TRACER;
...
public class Servlet30Advice {
  ...
  public static void onEnter(
    ...
    if (!(response instanceof AbstractCountingHttpServletResponse)) {
      response = new Servlet30CountingHttpServletResponse((HttpServletResponse) response);
      request =
