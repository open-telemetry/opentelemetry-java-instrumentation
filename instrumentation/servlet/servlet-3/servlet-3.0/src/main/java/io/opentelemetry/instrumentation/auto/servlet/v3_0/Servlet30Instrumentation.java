...
public final class Servlet30Instrumentation extends Instrumenter.Default {
  public Servlet30Instrumentation() {
  ...
  public String[] helperClassNames() {
    ...
    return new String[] {
      ...
      packageName + ".Servlet30CountingHttpServletResponse",
      packageName + ".Servlet30CountingHttpServletResponse$CountingServletOutputStream",
    };
  }
