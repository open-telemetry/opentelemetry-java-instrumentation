...
public class Servlet31CountingHttpServletResponse extends AbstractCountingHttpServletResponse {
   ...
   */
  public Servlet31CountingHttpServletResponse(HttpServletResponse response) {
    super(response);
  }
