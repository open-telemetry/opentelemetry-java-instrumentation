...
package io.opentelemetry.instrumentation.auto.servlet.v3;
...
public abstract class AbstractCountingHttpServletResponse extends HttpServletResponseWrapper {
   ...
   */
  protected AbstractCountingHttpServletResponse(HttpServletResponse response) {
    super(response);
  }
  ...
  public int getContentLength() {
    ...
    contentLength += getOutputStreamCounter();
    if (printWriter != null) {
  ...
  protected abstract int getOutputStreamCounter();
