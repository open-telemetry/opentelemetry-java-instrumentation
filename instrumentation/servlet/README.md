...
| `otel.instrumentation.servlet.experimental.capture-request-parameters`         | List    | Empty   | Deprecated include-only alias for `otel.instrumentation.servlet.experimental.request-parameters.included`; ignored under v3 preview and will be removed in 3.0. |
