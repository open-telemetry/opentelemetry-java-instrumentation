...
public class ServletHttpAttributeGetter<REQUEST, RESPONSE>
    implements HttpServerAttributeGetter<
        ServletRequestContext<REQUEST>, ServletResponseContext<RESPONSE>> {

  protected final ServletAccessor<REQUEST, RESPONSE> accessor;

  public ServletHttpAttributeGetter(ServletAccessor<REQUEST, RESPONSE> accessor) {
