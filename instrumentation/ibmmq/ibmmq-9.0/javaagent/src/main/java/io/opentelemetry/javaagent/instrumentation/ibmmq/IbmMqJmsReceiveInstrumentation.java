...
// The generic JMS instrumentation ends receive()/receiveNoWait() spans via startAndEnd, so
// they're never current -- this only remembers the QMID here for a later span to pick up.
