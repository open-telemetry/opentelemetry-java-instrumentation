...
public final class SqsProcessTracing {
   ...
   * processing itself. Views have independent ownership and must be marked separately. Only the
   * first application traversal of the response or any view can produce raw process spans.
   *
