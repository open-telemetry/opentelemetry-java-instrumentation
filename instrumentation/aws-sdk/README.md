...
| `otel.instrumentation.aws-sdk.message-create-spans.enabled`              | Boolean | `true`  | Emit a create span for each eligible message of an SQS batch send. Overrides the common messaging setting.                            |
