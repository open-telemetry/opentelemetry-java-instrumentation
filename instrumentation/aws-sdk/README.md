...
| `otel.instrumentation.aws-sdk.experimental.message-create-spans.enabled` | Boolean | `true`  | Emit a create span for each message of an SQS batch send, when stable messaging semantic conventions are enabled.                     |
