...
| `otel.instrumentation.messaging.batch-send.message-creation-spans.enabled` | Boolean | `true`  | Emit a create span for each eligible message of an SQS batch send, when stable messaging semantic conventions are enabled.            |
