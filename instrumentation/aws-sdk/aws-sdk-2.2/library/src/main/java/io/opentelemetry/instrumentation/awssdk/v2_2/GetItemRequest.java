...
public class GetItemRequest implements DbRequest {

  private SdkRequest sdkRequest;

  public GetItemRequest(SdkRequest sdkRequest) {
    this.sdkRequest = sdkRequest;
  }

  @Override
  public String statement() {
    StringBuilder builder = new StringBuilder("GET ITEM");

    sdkRequest
        .getValueForField("TableName", String.class)
        .ifPresent(val -> builder.append(" From: ").append(val));
    sdkRequest
        .getValueForField("AttributesToGet", List.class)
        .ifPresent(
            val ->
                builder.append(" Select: ").append(val.stream().collect(Collectors.joining(","))));
    sdkRequest
