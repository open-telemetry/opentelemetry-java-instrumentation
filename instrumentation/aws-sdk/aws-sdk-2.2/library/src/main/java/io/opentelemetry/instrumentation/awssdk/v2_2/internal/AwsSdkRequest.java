...
enum AwsSdkRequest {
  ...
  BatchGetItem(
      ...
      request(SemconvAttributes.AWS_DYNAMODB_TABLE_NAMES, "RequestItems"),
      response(SemconvAttributes.AWS_DYNAMODB_CONSUMED_CAPACITY, "ConsumedCapacity")),
  BatchWriteItem(
      DYNAMODB,
      "dynamodb.model.BatchWriteItemRequest",
      request(SemconvAttributes.AWS_DYNAMODB_TABLE_NAMES, "RequestItems"),
      response(SemconvAttributes.AWS_DYNAMODB_CONSUMED_CAPACITY, "ConsumedCapacity"),
      response(SemconvAttributes.AWS_DYNAMODB_ITEM_COLLECTION_METRICS, "ItemCollectionMetrics")),
  CreateTable(
      DYNAMODB,
      "dynamodb.model.CreateTableRequest",
      request(SemconvAttributes.AWS_DYNAMODB_TABLE_NAMES, "TableName"),
      request(SemconvAttributes.AWS_DYNAMODB_GLOBAL_SECONDARY_INDEXES, "GlobalSecondaryIndexes"),
      request(SemconvAttributes.AWS_DYNAMODB_LOCAL_SECONDARY_INDEXES, "LocalSecondaryIndexes"),
      request(
          SemconvAttributes.AWS_DYNAMODB_PROVISIONED_READ_CAPACITY,
          "ProvisionedThroughput.ReadCapacityUnits"),
      request(
          SemconvAttributes.AWS_DYNAMODB_PROVISIONED_WRITE_CAPACITY,
  ...
  GetItem(
      ...
      request(SemconvAttributes.AWS_DYNAMODB_TABLE_NAMES, "TableName"),
      request(SemconvAttributes.AWS_DYNAMODB_PROJECTION, "ProjectionExpression"),
      request(SemconvAttributes.AWS_DYNAMODB_CONSISTENT_READ, "ConsistentRead"),
      response(SemconvAttributes.AWS_DYNAMODB_CONSUMED_CAPACITY, "ConsumedCapacity")),
  ListTables(
      DYNAMODB,
      "dynamodb.model.ListTablesRequest",
      request(SemconvAttributes.AWS_DYNAMODB_EXCLUSIVE_START_TABLE, "ExclusiveStartTableName"),
      response(SemconvAttributes.AWS_DYNAMODB_TABLE_COUNT, "TableNames"),
      request(SemconvAttributes.AWS_DYNAMODB_LIMIT, "Limit")),
  PutItem(
      DYNAMODB,
  ...
  Query(
      ...
      request(SemconvAttributes.AWS_DYNAMODB_TABLE_NAMES, "TableName"),
      request(SemconvAttributes.AWS_DYNAMODB_ATTRIBUTES_TO_GET, "AttributesToGet"),
      request(SemconvAttributes.AWS_DYNAMODB_CONSISTENT_READ, "ConsistentRead"),
      request(SemconvAttributes.AWS_DYNAMODB_INDEX_NAME, "IndexName"),
      request(SemconvAttributes.AWS_DYNAMODB_LIMIT, "Limit"),
      request(SemconvAttributes.AWS_DYNAMODB_PROJECTION, "ProjectionExpression"),
      request(SemconvAttributes.AWS_DYNAMODB_SCAN_FORWARD, "ScanIndexForward"),
      request(SemconvAttributes.AWS_DYNAMODB_SELECT, "Select"),
      response(SemconvAttributes.AWS_DYNAMODB_CONSUMED_CAPACITY, "ConsumedCapacity")),
  Scan(
      DYNAMODB,
      ...
      request(SemconvAttributes.AWS_DYNAMODB_LIMIT, "Limit"),
      request(SemconvAttributes.AWS_DYNAMODB_PROJECTION, "ProjectionExpression"),
      request(SemconvAttributes.AWS_DYNAMODB_SEGMENT, "Segment"),
      request(SemconvAttributes.AWS_DYNAMODB_SELECT, "Select"),
      request(SemconvAttributes.AWS_DYNAMODB_TOTAL_SEGMENTS, "TotalSegments"),
      response(SemconvAttributes.AWS_DYNAMODB_CONSUMED_CAPACITY, "ConsumedCapacity"),
      response(SemconvAttributes.AWS_DYNAMODB_COUNT, "Count"),
      response(SemconvAttributes.AWS_DYNAMODB_SCANNED_COUNT, "ScannedCount")),
  UpdateItem(
      DYNAMODB,
  ...
  UpdateTable(
      ...
      request(SemconvAttributes.AWS_DYNAMODB_TABLE_NAMES, "TableName"),
      request(SemconvAttributes.AWS_DYNAMODB_ATTRIBUTE_DEFINITIONS, "AttributeDefinitions"),
      request(
          SemconvAttributes.AWS_DYNAMODB_GLOBAL_SECONDARY_INDEX_UPDATES,
  ...
  ConverseRequest(
      ...
      request(SemconvAttributes.GEN_AI_REQUEST_MODEL, "modelId"));
  ...
  private static class SemconvAttributes {
