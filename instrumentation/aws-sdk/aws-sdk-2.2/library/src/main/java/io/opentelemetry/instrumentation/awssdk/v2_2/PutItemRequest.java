...
public class PutItemRequest implements DbRequest {

  private SdkRequest sdkRequest;

  public PutItemRequest(SdkRequest sdkRequest) {
  ...
  public String statement() {
    ...
    sdkRequest
        ...
        .ifPresent(val -> builder.append(" Into: ").append(val));
    sdkRequest
        .getValueForField("Item", Map.class)
        .ifPresent(val -> builder.append(" Values: ").append(serializeKey(val)));
    sdkRequest
