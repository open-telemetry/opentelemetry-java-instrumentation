...
abstract class AbstractKtorServerTracing(
  private val instrumenter: Instrumenter<ApplicationRequest, ApplicationResponse>
) {
  class Configuration(private val instrumentationName: String) {
    companion object {
      init {
  ...
  protected fun start(call: ApplicationCall): Context? {
  ...
  protected fun end(context: Context, call: ApplicationCall, error: Throwable?) {
