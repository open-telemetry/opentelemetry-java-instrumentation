...
class KtorClientTracingBuilder {
  ...
  fun setOpenTelemetry(openTelemetry: OpenTelemetry) {
    ...
    this.clientBuilder = DefaultHttpClientInstrumenterBuilder.create(INSTRUMENTATION_NAME, openTelemetry, KtorHttpClientAttributesGetter)
  }

  @Deprecated("Please use method `capturedRequestHeaders`", ReplaceWith("capturedRequestHeaders(headers.asIterable())"))
  ...
  @Deprecated("Please use method `capturedResponseHeaders`", ReplaceWith("capturedResponseHeaders(headers.asIterable())"))
  ...
  fun attributeExtractor(extractorBuilder: ExtractorBuilder.() -> Unit = {}) {
    ...
    this.clientBuilder.addAttributeExtractor(object : AttributesExtractor<HttpRequestData, HttpResponse> {
  ...
  data class OnStartData(val attributes: AttributesBuilder, val parentContext: Context, val request: HttpRequestData)

  data class OnEndData(val attributes: AttributesBuilder, val parentContext: Context, val request: HttpRequestData, val response: HttpResponse?, val error: Throwable?)
