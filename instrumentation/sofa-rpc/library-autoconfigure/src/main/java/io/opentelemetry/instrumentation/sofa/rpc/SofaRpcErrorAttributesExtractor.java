 ...
 * exception is present, it uses the exception's class name as the error type, which follows
 * the OpenTelemetry semantic conventions for error reporting.
 *
...
final class SofaRpcErrorAttributesExtractor
  ...
  @Override
  public void onStart(
      AttributesBuilder attributes, Context parentContext, SofaRpcRequest request) {
    // No start attributes
  }
