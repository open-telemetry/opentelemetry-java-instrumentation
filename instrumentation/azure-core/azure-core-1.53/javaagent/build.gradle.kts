...
sourceSets {
  main {
    val shadedDep =
      project(":instrumentation:azure-core:azure-core-1.53:library-instrumentation-shaded")
    output.dir(
      shadedDep.file("build/extracted/shadow"),
      "builtBy" to
        ":instrumentation:azure-core:azure-core-1.53:library-instrumentation-shaded:extractShadowJar",
    )
  }
}
...
dependencies {
  compileOnly(
    project(
      ":instrumentation:azure-core:azure-core-1.53:library-instrumentation-shaded",
