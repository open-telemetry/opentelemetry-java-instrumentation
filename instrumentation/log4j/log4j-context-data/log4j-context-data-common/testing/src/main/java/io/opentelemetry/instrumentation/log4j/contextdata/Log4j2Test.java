...
public abstract class Log4j2Test {
  ...
  void testNoIdsWhenNoSpan() {
    ...
    assertThat(
            events.get(0).getContextData().get(expectLoggingKeys() ? "trace_id_test" : "trace_id"))
        .isNull();
    assertThat(events.get(0).getContextData().get(expectLoggingKeys() ? "span_id_test" : "span_id"))
        .isNull();
    assertThat(
            events
                .get(0)
    ...
    assertThat(
            events.get(1).getContextData().get(expectLoggingKeys() ? "trace_id_test" : "trace_id"))
        .isNull();
    assertThat(events.get(1).getContextData().get(expectLoggingKeys() ? "span_id_test" : "span_id"))
        .isNull();
    assertThat(
            events
                .get(1)
  ...
  void testIdsWhenSpan() {
    ...
    assertThat(
            events.get(2).getContextData().get(expectLoggingKeys() ? "trace_id_test" : "trace_id"))
        .isNull();
    assertThat(events.get(2).getContextData().get(expectLoggingKeys() ? "span_id_test" : "span_id"))
        .isNull();
    assertThat(
            events
                .get(2)
    ...
    assertThat(
            events.get(3).getContextData().get(expectLoggingKeys() ? "trace_id_test" : "trace_id"))
        .isEqualTo(span2.getSpanContext().getTraceId());
    assertThat(events.get(3).getContextData().get(expectLoggingKeys() ? "span_id_test" : "span_id"))
