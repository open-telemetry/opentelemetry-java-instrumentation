...
public final class ContextDataKeys {
  ...
  public static ContextDataKeys create(OpenTelemetry openTelemetry) {
    ...
    return new ContextDataKeys(
        logging.getString("trace_id", LoggingContextConstants.TRACE_ID),
        logging.getString("span_id", LoggingContextConstants.SPAN_ID),
        logging.getString("trace_flags", LoggingContextConstants.TRACE_FLAGS));
  }
