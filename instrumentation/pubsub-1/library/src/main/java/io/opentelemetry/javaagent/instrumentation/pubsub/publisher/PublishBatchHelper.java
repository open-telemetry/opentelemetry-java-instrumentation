...
public class PublishBatchHelper {
  ...
  public static final Instrumenter<Request, Void> INSTRUMENTER =
  ...
  static SpanNameExtractor<Request> spanNameExtractor() {
    return req ->
        PubsubUtils.getSpanName(SemanticAttributes.MessagingOperationValues.PUBLISH, req.topicName);
  }
