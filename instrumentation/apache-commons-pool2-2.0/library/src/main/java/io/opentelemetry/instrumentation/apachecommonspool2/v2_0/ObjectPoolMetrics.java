...
final class ObjectPoolMetrics {
  ...
  ObservableLongMeasurement objects() {
    return meter
        .upDownCounterBuilder("apache.commons_pool2.object.count")
        .setUnit("{object}")
        .setDescription(
  ...
  ObservableLongMeasurement minIdleObjects() {
    return meter
        .upDownCounterBuilder("apache.commons_pool2.object.idle.min")
        .setUnit("{object}")
  ...
  ObservableLongMeasurement maxIdleObjects() {
    return meter
        .upDownCounterBuilder("apache.commons_pool2.object.idle.max")
        .setUnit("{object}")
  ...
  ObservableLongMeasurement maxObjects() {
    return meter
        .upDownCounterBuilder("apache.commons_pool2.object.max")
        .setUnit("{object}")
  ...
  ObservableLongMeasurement pendingRequestsForObject() {
    return meter
        .upDownCounterBuilder("apache.commons_pool2.request.pending")
        .setUnit("{request}")
