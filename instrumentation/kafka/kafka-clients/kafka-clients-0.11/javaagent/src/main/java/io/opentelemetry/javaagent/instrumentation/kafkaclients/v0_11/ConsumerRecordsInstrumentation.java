...
import static io.opentelemetry.javaagent.bootstrap.kafka.KafkaClientsConsumerProcessTracing.getProcessSpanEnabledSupplier;
  ...
  public static class ListAdvice {
    ...
    public static <K, V> List<ConsumerRecord<K, V>> wrap(
      ...
      return TracingList.wrap(
          list, consumerProcessInstrumenter(), getProcessSpanEnabledSupplier(), consumerContext);
    }
  }
