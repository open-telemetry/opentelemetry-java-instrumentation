...
import io.opentelemetry.instrumentation.api.incubator.semconv.db.SqlClientAttributeGetter;
import javax.annotation.Nullable;

public enum VertxSqlClientAttributeGetter
    implements SqlClientAttributeGetter<VertxSqlClientRequest> {
  INSTANCE;
