...
package io.opentelemetry.instrumentation.commonspool2;
...
public abstract class AbstractCommonsPool2InstrumentationTest {
  ...
  protected static final String INSTRUMENTATION_NAME = "io.opentelemetry.apache-commons-pool2";
  ...
  private void testGenericObjectPoolMetrics(boolean jmxEnabled) throws Exception {
    ...
    try {
      String poolName =
          "GenericObjectPool"
              + "-"
              + (jmxEnabled ? "pool1" : String.valueOf(System.identityHashCode(pool)));
