...
import static io.opentelemetry.javaagent.instrumentation.jaxws.v3_0.JaxWsSingletons.instrumenter;
...
public class WebServiceProviderInstrumentation implements TypeInstrumentation {
  ...
  public ElementMatcher<ClassLoader> classLoaderOptimization() {
    return hasClassesNamed("jakarta.xml.ws.Provider");
  }

  @Override
  public ElementMatcher<TypeDescription> typeMatcher() {
    return implementsInterface(named("jakarta.xml.ws.Provider"));
  }
