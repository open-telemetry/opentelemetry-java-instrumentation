...
dependencies {
  ...
  testImplementation(project(":instrumentation:opentelemetry-instrumentation-api:opentelemetry-instrumentation-api-1.14:testing"))
  testInstrumentation(project(":instrumentation:opentelemetry-instrumentation-api:opentelemetry-instrumentation-api-1.14:testing"))
}
  ...
  suites {
    val testOldServerSpan by registering(JvmTestSuite::class) {
      dependencies {
        ...
        implementation(project(":instrumentation:opentelemetry-instrumentation-api:opentelemetry-instrumentation-api-1.14:testing"))
      }
    }
  }
}
