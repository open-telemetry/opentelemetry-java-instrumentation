...
/**
 * Propagates context with remote messages sent between Pekko cluster nodes. Artery uses the {@code
 * RemoteInstrument} SPI, while classic remoting appends an unknown protobuf field. The received
 * context is restored before dispatch so Pekko actor instrumentation can carry it to the receiving
 * actor.
 */
