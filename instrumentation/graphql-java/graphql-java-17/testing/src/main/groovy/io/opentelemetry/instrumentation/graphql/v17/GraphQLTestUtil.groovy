...
class GraphQLTestUtil {
  ...
  static GraphQLSchema schemaFromResource(String resourceFileName, RuntimeWiring wiring) {
    def stream = GraphQLTestUtil.class.getClassLoader().getResourceAsStream(resourceFileName)
    return schema(stream, wiring)
  }


  static GraphQLSchema schemaFile(String fileName, RuntimeWiring wiring) {
    def stream = GraphQLTestUtil.class.getClassLoader().getResourceAsStream(fileName)
