...
class MongoDbAttributeGetter implements DbClientAttributeGetter<CommandStartedEvent> {
  ...
  MongoDbAttributeGetter(boolean statementSanitizationEnabled, int maxNormalizedQueryLength) {
