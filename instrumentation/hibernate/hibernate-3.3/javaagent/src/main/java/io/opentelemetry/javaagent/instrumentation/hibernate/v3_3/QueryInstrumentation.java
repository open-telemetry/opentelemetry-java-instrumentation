...
import static io.opentelemetry.javaagent.instrumentation.hibernate.SpanNameUtil.getSpanNameForQuery;
  ...
  public static class QueryMethodAdvice {
    ...
    public static HibernateOperationScope startMethod(@Advice.This Query query) {
      ...
      HibernateOperation hibernateOperation =
          HibernateOperation.fromSpanName(getSpanNameForQuery(query.getQueryString()), sessionInfo);
