...
public class SessionTest extends AbstractHibernateTest {
  ...
  private static Stream<Arguments> provideArgumentsStateless() {
    return Stream.of(
        Arguments.of(named("refresh", new Parameter(
            ...
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            null,
            StatelessSession::refresh, null))),
        Arguments.of(named("get", new Parameter(
            "get",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            null,
            (StatelessSession session, Value val) ->  session.get("io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value", val.getId()), null))
        ));
  }
  ...
  void testHibernateFailedReplicate() {
    ...
    testing.waitAndAssertTraces(
        trace ->       trace.hasSpansSatisfyingExactly(
            span -> span.hasName("parent").hasKind(SpanKind.INTERNAL).hasNoParent(),
            span -> assertSessionSpan(span, trace.getSpan(0), "Session.replicate java.lang.Long"),
            span ->
                assertSpanWithSessionId(
                    span,
                    trace.getSpan(0),
  ...
  private static Stream<Arguments> provideArgumentsReplicate() {
    return Stream.of(
        Arguments.of(named("replicate", new Parameter(
            "replicate",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            ...
            null, null))),
        Arguments.of(named("replicate by entityName", new Parameter(
            "replicate",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> {
              Value replicated = new Value(val.getName() + " replicated");
              replicated.setId(val.getId());
              session.replicate("io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value", replicated, ReplicationMode.OVERWRITE);
            },
            null, null)))
    );
  }
  ...
  private static Stream<Arguments> provideArgumentsCommitAction() {
    return Stream.of(
        Arguments.of(named("save", new Parameter(
            "save",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> session.save(new Value("Another value")),
            null, null))),
        Arguments.of(named("saveOrUpdate save", new Parameter(
            "saveOrUpdate",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> session.saveOrUpdate(new Value("io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value")),
            null, null))),
        Arguments.of(named("saveOrUpdate update", new Parameter(
            "saveOrUpdate",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> {
              val.setName("New name");
            ...
            null, null))),
        Arguments.of(named("merge", new Parameter(
            "merge",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> session.merge(new Value("merge me in")),
            null, null))),
        Arguments.of(named("persist", new Parameter(
            "persist",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> session.persist(new Value("merge me in")),
            null, null))),
        Arguments.of(named("update (Session)", new Parameter(
            "update",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> {
              val.setName("New name");
            ...
            null, null))),
        Arguments.of(named("update by entityName (Session)", new Parameter(
            "update",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> {
              val.setName("New name");
            ...
            null, null))),
        Arguments.of(named("delete (Session)", new Parameter(
            "delete",
            "io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            (Session session, Value val) -> session.delete(val),
            null, null)))
    );
  }
  ...
  private static Stream<Arguments> provideArgumentsForQueryMethods() {
    return Stream.of(
        Arguments.of(named("createQuery", new Parameter(
            "createQuery",
            "SELECT io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value",
            null,
            null,
            (Session session) -> session.createQuery("from io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value")))),
        Arguments.of(named("getNamedQuery", new Parameter(
            "getNamedQuery",
            "SELECT Value",
            null,
            null,
            (Session session) -> session.getNamedQuery("TestNamedQuery")))),
        Arguments.of(named("createSQLQuery", new Parameter(
            "createSQLQuery",
            "SELECT Value",
            null,
            null,
  ...
  void testHibernateOverlappingSessions() {
    ...
    testing.runWithSpan(
        ...
        () -> {
          ...
          Value value1 = new Value("io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value 1");
    ...
    testing.waitAndAssertTraces(
        trace -> trace.hasSpansSatisfyingExactly(
            ...
            span -> assertSessionSpan(span, trace.getSpan(0), "Session.save io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value"),
            span -> assertSessionSpan(span, trace.getSpan(0), "Session.insert io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value"),
            span -> assertSessionSpan(span, trace.getSpan(0), "Session.save io.opentelemetry.javaagent.instrumentation.hibernate.v3_3.Value"),
            span -> assertSpanWithSessionId(
                span,
                trace.getSpan(0),
