...
/**
 * Instrumentation for methods annotated with {@link Timed} and {@link MetricAttribute} annotations.
 */
@AutoService(InstrumentationModule.class)
public class TimedInstrumentationModule extends InstrumentationModule {

  public TimedInstrumentationModule() {
    super("opentelemetry-instrumentation-annotation-timed", "timed");
  }
