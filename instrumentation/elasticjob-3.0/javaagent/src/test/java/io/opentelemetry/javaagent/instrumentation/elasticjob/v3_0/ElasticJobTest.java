...
public class ElasticJobTest {
  ...
  public void testHttpJob() throws InterruptedException {
    ...
    for (SpanData span : spans) {
      ...
      assertThat(span.getAttributes().get(AttributeKey.stringKey("scheduling.elasticjob.job.name")))
          .isEqualTo("javaHttpJob");
      assertThat(
              span.getAttributes()
                  .get(AttributeKey.longKey("scheduling.elasticjob.sharding.total.count")))
          .isEqualTo(3L);
      assertThat(
              span.getAttributes()
                  .get(AttributeKey.stringKey("scheduling.elasticjob.sharding.item.parameters")))
          .isEqualTo("{0=Beijing, 1=Shanghai, 2=Guangzhou}");

      assertThat(span.getAttributes().get(AttributeKey.longKey("scheduling.elasticjob.item")))
          .isIn(0L, 1L, 2L);
      assertThat(span.getAttributes().get(AttributeKey.stringKey("scheduling.elasticjob.task.id")))
    ...
    Set<Long> shardItems =
        spans.stream()
            .map(
                span ->
                    span.getAttributes().get(AttributeKey.longKey("scheduling.elasticjob.item")))
  ...
  public void testSimpleJob() throws InterruptedException {
    ...
    for (SpanData span : spans) {
      ...
      assertThat(span.getAttributes().get(AttributeKey.stringKey("code.namespace")))
          .isEqualTo(
              "io.opentelemetry.javaagent.instrumentation.elasticjob.v3_0.ElasticJobTest$SynchronizedTestSimpleJob");
      assertThat(span.getAttributes().get(AttributeKey.longKey("scheduling.elasticjob.item")))
          .isIn(0L, 1L);
      assertThat(span.getAttributes().get(AttributeKey.stringKey("scheduling.elasticjob.task.id")))
  ...
  public void testDataflowJob() throws InterruptedException {
    ...
    for (SpanData span : spans) {
      ...
      assertThat(span.getAttributes().get(AttributeKey.stringKey("code.namespace")))
          .isEqualTo(
              "io.opentelemetry.javaagent.instrumentation.elasticjob.v3_0.ElasticJobTest$SynchronizedTestDataflowJob");
      assertThat(span.getAttributes().get(AttributeKey.longKey("scheduling.elasticjob.item")))
          .isIn(0L, 1L);
      assertThat(span.getAttributes().get(AttributeKey.stringKey("scheduling.elasticjob.task.id")))
                          ...
                          span.hasKind(SpanKind.INTERNAL)
                              ...
                              .hasAttributesSatisfyingExactly(
                                  ...
                                  equalTo(
                                      ...
                                      "scriptElasticJob"),
                                  equalTo(AttributeKey.longKey("scheduling.elasticjob.item"), 0L),
                                  equalTo(
                                      AttributeKey.longKey(
                                          "scheduling.elasticjob.sharding.total.count"),
                                      1L),
                                  equalTo(
                                      AttributeKey.stringKey(
                                          "scheduling.elasticjob.sharding.item.parameters"),
                                      "{0=null}"),
                                  satisfies(
  ...
  public void testFailedJob() throws InterruptedException {
    ...
    assertThat(span.getAttributes().get(AttributeKey.stringKey("code.namespace")))
        .isEqualTo(
            "io.opentelemetry.javaagent.instrumentation.elasticjob.v3_0.ElasticJobTest$SynchronizedTestFailedJob");
