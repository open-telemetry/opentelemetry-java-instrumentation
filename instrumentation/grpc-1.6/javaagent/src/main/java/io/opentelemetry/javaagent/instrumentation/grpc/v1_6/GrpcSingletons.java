...
public final class GrpcSingletons {
  ...
  static {
    ...
    PeerServiceAttributesOnStartExtractor<GrpcRequest, Status> peerServiceAttributesExtractor =
        PeerServiceAttributesOnStartExtractor.create(new GrpcNetAttributesExtractor());
