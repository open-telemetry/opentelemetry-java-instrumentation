...
enum JmsMessageAttributeGetter implements MessagingAttributeGetter<MessageWithDestination, Void> {
  INSTANCE;

  private static final Logger logger = Logger.getLogger(JmsMessageAttributeGetter.class.getName());
