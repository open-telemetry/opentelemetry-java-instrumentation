...
import static io.opentelemetry.javaagent.instrumentation.scala.forkjoin.v2_8.VirtualFields.CALLABLE_PROPAGATED_CONTEXT;
import static io.opentelemetry.javaagent.instrumentation.scala.forkjoin.v2_8.VirtualFields.FORK_JOIN_TASK_PROPAGATED_CONTEXT;
import static io.opentelemetry.javaagent.instrumentation.scala.forkjoin.v2_8.VirtualFields.RUNNABLE_PROPAGATED_CONTEXT;
