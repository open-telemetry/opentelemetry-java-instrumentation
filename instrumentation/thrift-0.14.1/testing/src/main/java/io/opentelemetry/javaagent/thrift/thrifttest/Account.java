...
public class Account
    implements org.apache.thrift.TBase<Account, Account.Fields>,
  ...
  public boolean equals(Account that) {
    ...
    boolean thisPresentCardId = true && this.isSetCardId();
    boolean thatPresentCardId = true && that.isSetCardId();
    if (thisPresentCardId || thatPresentCardId) {
      if (!(thisPresentCardId && thatPresentCardId)) {
        return false;
      }
