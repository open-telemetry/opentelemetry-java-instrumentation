...
public class HttpServerRequestTracingHandler extends ChannelInboundHandlerAdapter {
  ...
  static final AttributeKey<NettyCommonRequest> HTTP_SERVER_REQUEST =
  ...
  public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
    ...
    Attribute<NettyCommonRequest> requestAttr = channel.attr(HTTP_SERVER_REQUEST);
    ...
    NettyCommonRequest request = NettyCommonRequest.create((HttpRequest) msg, channel);
    ...
    try (Scope ignored = context.makeCurrent()) {
      ...
      instrumenter().end(contextAttr.getAndRemove(), requestAttr.getAndRemove(), null, t);
      throw t;
    }
