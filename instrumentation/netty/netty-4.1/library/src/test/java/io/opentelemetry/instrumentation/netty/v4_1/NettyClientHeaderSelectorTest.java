...
class NettyClientHeaderSelectorTest {
  ...
  void capturesEveryHeaderNotExcluded() {
    NettyClientTelemetry telemetry =
    ...
    Attributes attributes = exchange(telemetry);
  ...
  private static Attributes exchange(NettyClientTelemetry telemetry) {
    EmbeddedChannel channel = new EmbeddedChannel(telemetry.createCombinedHandler());
