...
final class ClickHouseAttributesGetter
  ...
  public String getDbOperationName(ClickHouseDbRequest request) {
    ...
    String operationName = request.getSqlStatementInfo().getOperationName();
    if (operationName != null && SemconvStability.emitOldDatabaseSemconv()) {
      operationName = operationName.toUpperCase(Locale.ROOT);
    }
