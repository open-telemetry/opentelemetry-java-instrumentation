...
public class ClickHouseClientV2Singletons {
  ...
  static DbServerTarget parseConfiguredServerTarget(Set<String> endpoints) {
    ...
    for (String endpoint : endpoints) {
      ...
      builder.addEndpoint(
          extracted.address, extracted.port == null ? -1 : extracted.port, extracted.defaultPort());
    }
  ...
  // TODO replace these temporary helpers with DbServerEndpointUtil once #20015 merges.
  ...
  private static class EndpointTarget {
    ...
    @Nullable
    private static EndpointTarget parse(String endpoint) {
      ...
      if (firstColon >= 0) {
        ...
        if (port != null && ClickHouseClientV2Singletons.isIpv6Literal(address)) {
