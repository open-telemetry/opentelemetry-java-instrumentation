 ...
 * at any time.
 *
 * @deprecated Use {@link io.opentelemetry.instrumentation.runtimetelemetry.RuntimeTelemetry}
...
public final class ExperimentalMemoryPools {
  ...
  public static List<AutoCloseable> registerObservers(Meter meter) {
    return registerObservers(meter, ManagementFactory.getMemoryPoolMXBeans());
  }

  // Visible for testing
  static List<AutoCloseable> registerObservers(Meter meter, List<MemoryPoolMXBean> poolBeans) {
