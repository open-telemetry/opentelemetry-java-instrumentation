...
public final class ParallelHeapSummaryHandler implements RecordedEventHandler {
  ...
  private static final Attributes ATTR_MEMORY_EDEN =
      Attributes.of(Constants.ATTR_MEMORY_TYPE, Constants.HEAP, Constants.ATTR_MEMORY_POOL, "PS Eden Space");
  private static final Attributes ATTR_MEMORY_SURVIVOR =
      Attributes.of(Constants.ATTR_MEMORY_TYPE, Constants.HEAP, Constants.ATTR_MEMORY_POOL, "PS Survivor Space");
  private static final Attributes ATTR_MEMORY_OLD =
      Attributes.of(Constants.ATTR_MEMORY_TYPE, Constants.HEAP, Constants.ATTR_MEMORY_POOL, "PS Old Gen");
