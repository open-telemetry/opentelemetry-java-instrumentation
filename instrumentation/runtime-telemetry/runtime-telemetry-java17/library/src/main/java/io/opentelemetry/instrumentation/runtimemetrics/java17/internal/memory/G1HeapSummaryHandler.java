...
public final class G1HeapSummaryHandler implements RecordedEventHandler {
  ...
  private static final Attributes ATTR_MEMORY_EDEN =
      Attributes.of(Constants.ATTR_MEMORY_TYPE, Constants.HEAP, Constants.ATTR_MEMORY_POOL, "G1 Eden Space");
  private static final Attributes ATTR_MEMORY_SURVIVOR =
      Attributes.of(Constants.ATTR_MEMORY_TYPE, Constants.HEAP, Constants.ATTR_MEMORY_POOL, "G1 Survivor Space");
