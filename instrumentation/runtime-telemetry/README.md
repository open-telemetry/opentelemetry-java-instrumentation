...
| `otel.instrumentation.runtime-telemetry.experimental.jfr-metrics`                     | List    |         | Select metrics to source from JFR using exact names or trailing-`*` prefixes, for example `jvm.memory.*,jvm.cpu.longlock`. |
