...
public final class ArmeriaServerTelemetryBuilder {
  ...
  static {
    ArmeriaInstrumenterBuilderUtil.setServerBuilderExtractor(
        ArmeriaServerTelemetryBuilder::getBuilder);
  }
  ...
  @Deprecated
  @CanIgnoreReturnValue
  public ArmeriaServerTelemetryBuilder setEmitExperimentalHttpServerMetrics(
  ...
  private DefaultHttpServerInstrumenterBuilder<ServiceRequestContext, RequestLog> getBuilder() {
    return builder;
  }
}
