...
import io.opentelemetry.instrumentation.okhttp.v3_12.internal.Experimental;
import io.opentelemetry.instrumentation.okhttp.v3_12.internal.OkHttpClientInstrumenterBuilderFactory;
...
public final class OkHttpTelemetryBuilder {
  ...
  public OkHttpTelemetryBuilder addAttributesExtractor(
      AttributesExtractor<Call, Response> attributesExtractor) {
  ...
  public OkHttpTelemetryBuilder setSpanNameExtractorCustomizer(
      UnaryOperator<SpanNameExtractor<Call>> spanNameExtractorCustomizer) {
