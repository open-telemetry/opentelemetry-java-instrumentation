...
class OkHttp3Test extends HttpClientTest<Request> implements LibraryTestTrait {
  ...
  @Shared
  def client = OkHttpTracing.create(getOpenTelemetry())
    .newCallFactory(newOkHttpClientBuilder().build())
