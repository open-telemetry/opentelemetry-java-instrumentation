  ...
  def "receiving message in spring listener generates spans"() {
    ...
    assertTraces(2) {
      trace(0, 2) {
        ...
        consumerSpan(it, 1, "SpringListenerJMS2", true, MessagingMessageListenerAdapter, span(0))
      }
      trace(1, 1) {
        consumerSpan(it, 0, "SpringListenerJMS2", false, HornetQMessageConsumer, traces[0][0])
      }
    }
  }
}
