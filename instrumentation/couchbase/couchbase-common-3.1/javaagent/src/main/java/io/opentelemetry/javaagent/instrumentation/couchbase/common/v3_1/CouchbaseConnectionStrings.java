...
// Parsing the connection string preserves configured endpoint order and DNS SRV identity.
  ...
  public static CouchbaseServerTarget target(@Nullable ConnectionString connectionString) {
    ...
    try {
      ...
      if (connectionString.isValidDnsSrv()
          && !scheme.equalsIgnoreCase("couchbase2")
          && !scheme.equalsIgnoreCase("protostellar")) {
