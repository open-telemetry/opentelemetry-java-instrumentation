...
// Core constructor signatures vary across the supported releases. Current clients convert direct
// seed sets to connection strings before construction, so their factory restores the deterministic
// direct-seed target afterward.
