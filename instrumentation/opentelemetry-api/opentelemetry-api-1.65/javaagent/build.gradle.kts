...
dependencies {
  ...
  implementation(project(":instrumentation:opentelemetry-api:opentelemetry-api-1.63:javaagent"))

  testImplementation("io.opentelemetry:opentelemetry-api-incubator:1.65.0-alpha")
}

configurations.configureEach {
  if (name.endsWith("testRuntimeClasspath", true) || name.endsWith("testCompileClasspath", true)) {
    resolutionStrategy {
      force("io.opentelemetry:opentelemetry-api:1.65.0")
      force("io.opentelemetry:opentelemetry-api-incubator:1.65.0-alpha")
    }
  }
}
