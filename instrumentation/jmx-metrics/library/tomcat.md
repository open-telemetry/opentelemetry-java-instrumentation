...
| tomcat.db.client.connection.initial    | UpDownCounter | {connection} | tomcat.host, tomcat.context, db.client.connection.pool.name                             | The configured initial size of the JDBC connection pool.   |
| tomcat.db.client.connection.count      | UpDownCounter | {connection} | tomcat.host, tomcat.context, db.client.connection.pool.name, db.client.connection.state | The number of JDBC connections.                            |
| tomcat.db.client.connection.limit      | UpDownCounter | {connection} | tomcat.host, tomcat.context, db.client.connection.pool.name                             | The configured maximum size of the JDBC connection pool.   |
