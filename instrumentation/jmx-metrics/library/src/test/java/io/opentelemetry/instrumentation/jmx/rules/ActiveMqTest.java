...
public class ActiveMqTest extends TargetSystemTest {
  ...
  private static MetricsVerifier createMetricsVerifier() {
    ...
    return MetricsVerifier.create()
        ...
        .add("activemq.temp.destination.utilization", metric -> metric.isGauge()
            .hasUnit("1")
            .hasDataPointsWithAttributes(topicAttributes)
        ...
        .add("activemq.memory.utilization", metric -> metric.isGauge()
            .hasUnit("1")
            .hasDataPointsWithAttributes(brokerAttributes)
        ...
        .add("activemq.store.utilization", metric -> metric.isGauge()
            .hasUnit("1")
            .hasDataPointsWithAttributes(brokerAttributes)
            .hasDescription("The percentage of broker persistent storage used"))
        .add("activemq.store.limit", metric -> metric.isUpDownCounter()
            .hasUnit("By")
            .hasDataPointsWithAttributes(brokerAttributes)
        ...
        .add("activemq.temp.limit", metric -> metric.isUpDownCounter()
            .hasUnit("By")
            .hasDataPointsWithAttributes(brokerAttributes)
            .hasDescription("The amount of configured broker non-persistent storage limit"))
        ;
