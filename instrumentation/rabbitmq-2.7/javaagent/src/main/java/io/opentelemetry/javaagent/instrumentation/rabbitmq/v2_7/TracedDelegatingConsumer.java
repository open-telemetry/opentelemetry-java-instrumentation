...
public class TracedDelegatingConsumer implements Consumer {
  ...
  private final boolean clientProcessingSelected;

  public TracedDelegatingConsumer(
      String queue, Consumer delegate, Connection connection, boolean clientProcessingSelected) {
    this.queue = queue;
    this.delegate = delegate;
    this.connection = connection;
    this.clientProcessingSelected = clientProcessingSelected;
  }
