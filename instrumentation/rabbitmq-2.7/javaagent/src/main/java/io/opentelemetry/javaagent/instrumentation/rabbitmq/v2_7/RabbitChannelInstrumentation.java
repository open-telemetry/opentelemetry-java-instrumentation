...
import static io.opentelemetry.javaagent.bootstrap.rabbitmq.RabbitMqConsumerProcessTracing.isSuppressed;
    ...
    public static Object wrapConsumer(
      ...
      if (consumer != null && !(consumer instanceof TracedDelegatingConsumer)) {
        return new TracedDelegatingConsumer(
            queue, consumer, channel.getConnection(), !isSuppressed(PROCESS, SPAN));
      }
