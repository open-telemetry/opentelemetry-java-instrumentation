...
import static io.opentelemetry.instrumentation.auto.jetty.Jetty8HttpServerTracer.TRACER;
...
import io.opentelemetry.instrumentation.auto.servlet.v3_0.Servlet30CountingHttpServletResponse;
...
public class Jetty8HandlerAdvice {
  ...
  public static void onEnter(
    ...
    if (!(response instanceof AbstractCountingHttpServletResponse)) {
      response = new Servlet30CountingHttpServletResponse(response);
