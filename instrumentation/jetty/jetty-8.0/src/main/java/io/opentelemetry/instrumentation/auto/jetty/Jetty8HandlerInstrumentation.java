...
public final class Jetty8HandlerInstrumentation extends Instrumenter.Default {

  public Jetty8HandlerInstrumentation() {
    super("jetty", "jetty-8");
  }
  ...
  public ElementMatcher<ClassLoader> classLoaderMatcher() {
    return hasClassesNamed("org.eclipse.jetty.server.Handler")
        // Jetty 8.0 uses servlet-api 3.0
        // WriteListener was added in servlet-api 3.1, 3.0 does not have it
        .and(not(hasClassesNamed("javax.servlet.WriteListener")));
  }
  ...
  public String[] helperClassNames() {
    ...
    String servlet30PackageName = "io.opentelemetry.instrumentation.auto.servlet.v3_0";
    return new String[] {
      ...
      servlet30PackageName + ".Servlet30CountingHttpServletResponse",
      servlet30PackageName + ".Servlet30CountingHttpServletResponse$CountingServletOutputStream",
      packageName + ".Jetty8HttpServerTracer",
    };
  }
  ...
  public Map<? extends ElementMatcher<? super MethodDescription>, String> transformers() {
    return singletonMap(
        named("handle")
            ...
            .and(isPublic()),
        packageName + ".Jetty8HandlerAdvice");
  }
}
