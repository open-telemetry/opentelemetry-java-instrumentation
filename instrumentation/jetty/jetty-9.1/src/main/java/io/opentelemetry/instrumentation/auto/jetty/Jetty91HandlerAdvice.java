...
import static io.opentelemetry.instrumentation.auto.jetty.Jetty91HttpServerTracer.TRACER;

import io.grpc.Context;
import io.opentelemetry.context.Scope;
import io.opentelemetry.instrumentation.auto.servlet.v3.AbstractCountingHttpServletResponse;
import io.opentelemetry.instrumentation.auto.servlet.v3.CountingHttpServletRequest;
import io.opentelemetry.instrumentation.auto.servlet.v3.TagSettingAsyncListener;
import io.opentelemetry.instrumentation.auto.servlet.v3_1.Servlet31CountingHttpServletResponse;
...
public class Jetty91HandlerAdvice {
  ...
  public static void onEnter(
    ...
    if (!(response instanceof AbstractCountingHttpServletResponse)) {
      response = new Servlet31CountingHttpServletResponse(response);
