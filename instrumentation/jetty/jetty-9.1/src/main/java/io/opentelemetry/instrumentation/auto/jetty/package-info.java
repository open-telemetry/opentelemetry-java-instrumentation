 ...
 * has its own {@code Jetty91HandlerInstrumentation} and {@code Jetty91HandlerAdvice}. But this is
 * the only difference between two instrumentations, thus {@link
 * io.opentelemetry.instrumentation.auto.jetty.Jetty91HttpServerTracer} is a very thin subclass of
