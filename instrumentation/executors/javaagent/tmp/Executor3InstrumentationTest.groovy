...
class Executor3InstrumentationTest extends AgentInstrumentationSpecification {
  ...
  def "#poolName '#name' propagates"() {
    ...
    assertTraces(1) {
      trace(0, 2) {
        ...
        io.opentelemetry.instrumentation.test.utils.TraceUtils.basicSpan(it, 1, "asyncChild", span(0))
      }
    }
