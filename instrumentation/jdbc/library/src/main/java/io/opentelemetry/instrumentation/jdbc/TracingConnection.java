...
public class TracingConnection implements Connection {
  ...
  public Statement createStatement() throws SQLException {
    ...
    return WrapperProxy.wrap(
        ...
        new TracingStatement(
            statement, connectionInfo, withActiveSpanOnly, ignoreStatements, tracer));
  }
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    ...
    return WrapperProxy.wrap(
        statement,
        new TracingPreparedStatement(
            statement, sql, connectionInfo, withActiveSpanOnly, ignoreStatements, tracer));
  }
  ...
  public void rollback() throws SQLException {
    JdbcTracingUtils.execute(
        "Rollback", connection::rollback, null, connectionInfo, withActiveSpanOnly, null, tracer);
  }

  @Override
  public void close() throws SQLException {
    JdbcTracingUtils.execute(
        "Close", connection::close, null, connectionInfo, withActiveSpanOnly, null, tracer);
  }
