...
class OpenTelemetryStatement<S extends Statement> implements Statement {
  ...
  public int executeUpdate(String sql) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.executeUpdate(processedSql));
  }

  @Override
  public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.executeUpdate(processedSql, autoGeneratedKeys));
  }

  @Override
  public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.executeUpdate(processedSql, columnIndexes));
  }

  @Override
  public int executeUpdate(String sql, String[] columnNames) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.executeUpdate(processedSql, columnNames));
  }

  @Override
  public boolean execute(String sql) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.execute(processedSql));
  }

  @Override
  public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.execute(processedSql, autoGeneratedKeys));
  }

  @Override
  public boolean execute(String sql, int[] columnIndexes) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.execute(processedSql, columnIndexes));
  }

  @Override
  public boolean execute(String sql, String[] columnNames) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.execute(processedSql, columnNames));
  }
  ...
  public void addBatch(String sql) throws SQLException {
    String processedSql = processQuery(sql);
    delegate.addBatch(processedSql);
  ...
  public long executeLargeUpdate(String sql) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.executeLargeUpdate(processedSql));
  }

  @Override
  public long executeLargeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.executeLargeUpdate(processedSql, autoGeneratedKeys));
  }

  @Override
  public long executeLargeUpdate(String sql, int[] columnIndexes) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.executeLargeUpdate(processedSql, columnIndexes));
  }

  @Override
  public long executeLargeUpdate(String sql, String[] columnNames) throws SQLException {
    String processedSql = processQuery(sql);
    return wrapCall(sql, () -> delegate.executeLargeUpdate(processedSql, columnNames));
  }
  ...
  protected <T, E extends Exception> T wrapCall(String sql, ThrowingSupplier<T, E> callable)
      throws E {
    DbRequest request = DbRequest.create(dbInfo, sql, true);
  ...
  private <T, E extends Exception> T wrapBatchCall(ThrowingSupplier<T, E> callable) throws E {
    DbRequest request =
        DbRequest.create(dbInfo, batchCommands, batchSize, Collections.emptyMap(), true);
    return wrapCall(request, callable);
  }
}
