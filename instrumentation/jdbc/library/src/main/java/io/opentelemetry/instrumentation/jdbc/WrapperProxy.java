...
public final class WrapperProxy {
   ...
   * wrapping the provided {@code wrapper} instance, or, {@code wrapper} if {@code obj == wrapper},
   * or if {@code target} or {@code wrapper} is null.
   */
  ...
  public static <T> T wrap(final T obj, final T wrapper) {
    ...
    return (T) Proxy.newProxyInstance(objClass.getClassLoader(), Classes.getAllInterfaces(objClass),
          ...
          public Object invoke(final Object proxy, final Method method, final Object[] args)
            ...
            try {
              try {
                ...
                final Method specific = Classes
                    .getDeclaredMethodDeep(wrapperClass, method.getName(),
  ...
  public static boolean isWrapper(final Object obj) {
    return Proxy.isProxyClass(obj.getClass()) && Proxy
        .getInvocationHandler(obj) instanceof WrapperInvocationHandler;
  }
  ...
  public static <T> boolean isWrapper(final T obj, final Class<? extends T> wrappedClass) {
    ...
    return wrappedClass
        .isAssignableFrom(((WrapperInvocationHandler<?>) handler).getWrapper().getClass());
  }
