...
public final class Classes {
   ...
   * found.
   *
   * <p>Declared methods include public, protected, default (package) access, and private
   * visibility.
   *
   * <p>The {@code name} parameter is a String that specifies the simple name of the desired method,
   ...
   * clone() method.
   *
   * <p>This method differentiates itself from {@link Class#getDeclaredMethod(String, Class...)} by
   ...
   *     represented by {@code cls} (excluding inherited methods), or {@code null} if the method is
   *     not found.
   ...
   * @param parameterTypes The parameter array.
   * @return A Method object that reflects the specified declared method of the class or interface
   *     represented by {@code cls} (including inherited methods), or {@code null} if the method is
   *     not found.
   * @throws NullPointerException If {@code cls} or {@code name} is null.
   */
  public static Method getDeclaredMethodDeep(
      Class<?> cls, final String name, final Class<?>... parameterTypes) {
    Method method;
    do {
