...
class TracingStatement<S extends Statement> implements Statement {
  ...
  private static <T, E extends Exception> T executeStatement(
  ...
  public ResultSet executeQuery(String sql) throws SQLException {
    return executeStatement(delegate, sql, () -> delegate.executeQuery(sql));
  }

  @Override
  public int executeUpdate(String sql) throws SQLException {
    return executeStatement(delegate, sql, () -> delegate.executeUpdate(sql));
  }

  @Override
  public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
    return executeStatement(delegate, sql, () -> delegate.executeUpdate(sql, autoGeneratedKeys));
  }

  @Override
  public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
    return executeStatement(delegate, sql, () -> delegate.executeUpdate(sql, columnIndexes));
  }
  ...
  public boolean execute(String sql) throws SQLException {
    return executeStatement(delegate, sql, () -> delegate.execute(sql));
  }

  @Override
  public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
    return executeStatement(delegate, sql, () -> delegate.execute(sql, autoGeneratedKeys));
  }

  @Override
  public boolean execute(String sql, int[] columnIndexes) throws SQLException {
    return executeStatement(delegate, sql, () -> delegate.execute(sql, columnIndexes));
  }
  ...
  public int[] executeBatch() throws SQLException {
    return executeStatement(delegate, buildSqlForBatch(), delegate::executeBatch);
  }
