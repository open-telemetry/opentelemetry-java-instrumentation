...
class PreparedStatementParametersTest {
                ...
                span ->
                    span.hasName(spanName)
                        ...
                        .hasAttributesSatisfyingExactly(
                            ...
                            equalTo(maybeStable(DB_OPERATION), "SELECT"),
                            equalTo(maybeStable(DB_SQL_TABLE), table),
                            equalTo(DB_QUERY_PARAMETER.getAttributeKey("0"), "0"))));
  }
                ...
                span ->
                    span.hasName(spanName)
                        ...
                        .hasAttributesSatisfyingExactly(
                            ...
                            equalTo(maybeStable(DB_OPERATION), "SELECT"),
                            equalTo(maybeStable(DB_SQL_TABLE), table),
                            equalTo(DB_QUERY_PARAMETER.getAttributeKey("0"), "0.1"))));
  }
  ...
  void testDate2PreparedStatementParameter(
      ...
      String table)
      throws SQLException {
    String updatedColumn = query.replace("USER_NAME=?", "CURDATE()=?");
    String updatedColumnSanitized = sanitizedQuery.replace("USER_NAME=?", "CURDATE()=?");
    PreparedStatement statement = connection.prepareStatement(updatedColumn);
    cleanup.deferCleanup(statement);
  ...
  void testTime2PreparedStatementParameter(
      ...
      String table)
      throws SQLException {
    String updatedColumn = query.replace("USER_NAME=?", "CURTIME()=?");
    String updatedColumnSanitized = sanitizedQuery.replace("USER_NAME=?", "CURTIME()=?");
    PreparedStatement statement = connection.prepareStatement(updatedColumn);
    cleanup.deferCleanup(statement);
  ...
  void testTimestamp2PreparedStatementParameter(
      ...
      String table)
      throws SQLException {
    String updatedColumn = query.replace("USER_NAME=?", "NOW()=?");
    String updatedColumnSanitized = sanitizedQuery.replace("USER_NAME=?", "NOW()=?");
    PreparedStatement statement = connection.prepareStatement(updatedColumn);
    cleanup.deferCleanup(statement);
