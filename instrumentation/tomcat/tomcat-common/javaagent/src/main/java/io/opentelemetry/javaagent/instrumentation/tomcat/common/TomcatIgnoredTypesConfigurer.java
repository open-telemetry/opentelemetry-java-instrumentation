...
public class TomcatIgnoredTypesConfigurer implements IgnoredTypesConfigurer {
  ...
  public void configure(Config config, IgnoredTypesBuilder builder) {
    ...
    builder.ignoreTaskClass("org.apache.catalina.core.AsyncContextImpl$RunnableWrapper");
  }
}
