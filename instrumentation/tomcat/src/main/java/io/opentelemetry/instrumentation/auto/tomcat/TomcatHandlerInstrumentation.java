...
public final class TomcatHandlerInstrumentation extends Instrumenter.Default {

  public TomcatHandlerInstrumentation() {
    super("tomcat");
  }
  ...
  public ElementMatcher<ClassLoader> classLoaderMatcher() {
    ...
    return hasClassesNamed("org.apache.coyote.Adapter");
  }
  ...
  public Map<? extends ElementMatcher<? super MethodDescription>, String> transformers() {
    return singletonMap(
        named("service")
            ...
            .and(isPublic()),
        packageName + ".TomcatHandlerAdvice");
  }
}
