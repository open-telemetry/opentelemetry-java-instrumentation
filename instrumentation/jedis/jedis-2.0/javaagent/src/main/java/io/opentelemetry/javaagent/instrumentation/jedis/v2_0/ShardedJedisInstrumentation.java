...
class ShardedJedisInstrumentation implements TypeInstrumentation {
  ...
  public ElementMatcher<TypeDescription> typeMatcher() {
    return namedOneOf("redis.clients.jedis.BinaryShardedJedis", "redis.clients.util.Sharded");
  }
  ...
  public static class InitializeAdvice {
    ...
    public static void onExit(
      ...
      try {
        JedisSingletons.setShardedTarget(sharded, throwable == null ? scope.getTarget() : null);
      } finally {
        scope.close();
      }
    }
