...
public class JedisSingletons {
  ...
  @Nullable
  private static final VirtualField<Object, ClusterTargetState> CLUSTER_TARGET_STATE =
  ...
  public static void attachClusterTarget(Object handler, @Nullable Object connection) {
    ClusterTargetState state = getClusterTargetState(handler);
    if (state != null) {
      attach(state.target, connection);
    }
  }
  ...
  public static void attachClusterTargetToPools(Object handler, @Nullable Map<?, ?> pools) {
    ...
    for (Object pool : pools.values()) {
      if (pool instanceof Pool<?>) {
        setPoolTarget((Pool<?>) pool, state.target);
      }
    }
  }

  @Nullable
  public static ConfiguredTargetScope openClusterTargetScope(Object handler) {
    ClusterTargetState state = getClusterTargetState(handler);
  ...
  @Nullable
  private static VirtualField<Object, ClusterTargetState> getClusterTargetStateVirtualField() {
    try {
      Class<?> handlerClass =
          Class.forName(
      ...
      return (VirtualField<Object, ClusterTargetState>)
          VirtualField.find(handlerClass, ClusterTargetState.class);
  ...
  @Nullable
  private static ClusterTargetState getClusterTargetState(Object handler) {
    return CLUSTER_TARGET_STATE != null ? CLUSTER_TARGET_STATE.get(handler) : null;
  }
