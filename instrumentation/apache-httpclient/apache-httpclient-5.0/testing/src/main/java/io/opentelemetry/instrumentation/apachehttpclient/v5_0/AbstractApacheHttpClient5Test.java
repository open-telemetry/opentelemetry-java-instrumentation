...
public abstract class AbstractApacheHttpClient5Test {
  ...
  @Nested
  class ApacheClientHostRequestTest extends AbstractHttpClientTest<BasicClassicHttpRequest> {
  ...
  @Nested
  class ApacheClientHostRequestContextTest extends AbstractHttpClientTest<BasicClassicHttpRequest> {
  ...
  class ApacheClientHostAbsoluteUriRequestTest
      extends AbstractHttpClientTest<BasicClassicHttpRequest> {
  ...
  @Nested
  class ApacheClientUriRequestTest extends AbstractHttpClientTest<BasicClassicHttpRequest> {

    @Override
    public BasicClassicHttpRequest buildRequest(
        String method, URI uri, Map<String, String> headers) {
      // also testing with an absolute path below
      return configureRequest(new Http5UriRequest(method, uri), headers);
    }
  ...
  @Nested
  class ApacheClientUriRequestContextTest extends AbstractHttpClientTest<Http5UriRequest> {

    @Override
    public Http5UriRequest buildRequest(String method, URI uri, Map<String, String> headers) {
      // also testing with an absolute path below
      return configureRequest(new Http5UriRequest(method, uri), headers);
    }
    ...
    @Override
    public int sendRequest(
        Http5UriRequest request, String method, URI uri, Map<String, String> headers)
        throws Exception {
      return getClient(uri).execute(request, new BasicHttpContext(), responseHandler());
    }
