...
public class ApacheHttpClientTest {
  ...
  class ApacheClientHostRequestTest extends AbstractTest<BasicHttpRequest> {
    ...
    @Override
    void executeRequestWithCallback(BasicHttpRequest request, URI uri, RequestResult result)
        throws Exception {
  ...
  class ApacheClientUriRequestTest extends AbstractTest<HttpUriRequest> {
    ...
    @Override
    void executeRequestWithCallback(HttpUriRequest request, URI uri, RequestResult result)
        throws Exception {
  ...
  private static class HttpResponseHandler implements ResponseHandler<Void> {
    ...
    public HttpResponseHandler(AbstractHttpClientTest.RequestResult requestResult) {
