...
public final class ApacheHttpClientInstrumentation implements TypeInstrumentation {
  ...
  public static class UriRequestAdvice {
    ...
    public static void methodEnter(
      ...
      otelRequest = new ApacheHttpClientRequest(parentContext, request.getURI(), request);
      context = helper().startInstrumentation(parentContext, request, otelRequest);
    ...
    public static void methodExit(
      ...
      scope.close();
      helper().endInstrumentation(context, otelRequest, result, throwable);
    }
  }
