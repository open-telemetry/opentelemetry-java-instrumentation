...
include(":instrumentation:camunda:camunda-7.0:javaagent")
include(":instrumentation:camunda:camunda-7.0:library")
include(":instrumentation:camunda:camunda-7.0:testing")
