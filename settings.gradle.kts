...
include(":instrumentation:log4j:log4j-thread-context-1.2:javaagent")
include(":instrumentation:log4j:log4j-thread-context-2.7:javaagent")
include(":instrumentation:log4j:log4j-thread-context-2.16:javaagent")
include(":instrumentation:log4j:log4j-thread-context-2.16:library")
include(":instrumentation:log4j:log4j-thread-context-2.16:library-autoconfigure")
include(":instrumentation:log4j:log4j-thread-context-2-common:testing")
...
include(":instrumentation:ratpack-1.7:library")
