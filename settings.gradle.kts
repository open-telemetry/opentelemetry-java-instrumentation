...
include(":instrumentation:hbase:hbase-client-2.0.0:javaagent")
include(":instrumentation:hbase:hbase-common:javaagent")
include(":instrumentation:hbase:hbase-common:testing")
include(":instrumentation:hbase:hbase-shaded-client-2.0.0-testing")
