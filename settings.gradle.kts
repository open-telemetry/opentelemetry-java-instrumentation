...
include(":instrumentation:vertx:vertx-redis-client-3.9:javaagent")
include(":instrumentation:vertx:vertx-redis-client-4.0:javaagent")
include(":instrumentation:vertx:vertx-rx-java-3.5:javaagent")
include(":instrumentation:vertx:vertx-sql-client:vertx-sql-client-3.9:javaagent")
...
// vertx universal context persistence testing
include(":instrumentation:vertx:vertx-universal-context-persistence:testing")
