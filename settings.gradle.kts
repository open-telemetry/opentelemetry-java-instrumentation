...
// smoke tests
include(":smoke-tests:agent")
include(":smoke-tests:agent:images:fake-backend")
include(":smoke-tests:agent:images:grpc")
include(":smoke-tests:agent:images:play")
include(":smoke-tests:agent:images:quarkus")
include(":smoke-tests:agent:images:security-manager")
include(":smoke-tests:agent:images:servlet")
hideFromDependabot(":smoke-tests:agent:images:servlet:servlet-3.0")
hideFromDependabot(":smoke-tests:agent:images:servlet:servlet-5.0")
hideFromDependabot(":smoke-tests:agent:images:spring-boot")

include(":smoke-tests:spring-starter")
