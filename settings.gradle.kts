...
include(":instrumentation:executor-metrics:bootstrap")
include(":instrumentation:executor-metrics:javaagent")
include(":instrumentation:executor-metrics:jdk21-testing")
include(":instrumentation:executor-metrics:testing")
