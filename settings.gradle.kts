...
include(":instrumentation:rxjava:rxjava-3.1:javaagent")
include(":instrumentation:rxjava:rxjava-3.1:library")
...
include(":instrumentation:xxl-job:xxl-job-1.9:javaagent")
include(":instrumentation:xxl-job:xxl-job-2.1:javaagent")
include(":instrumentation:xxl-job:xxl-job-2.3:javaagent")
include(":instrumentation:xxl-job:xxl-job-common-1.9:javaagent")
include(":instrumentation:xxl-job:xxl-job-common-1.9:testing")
