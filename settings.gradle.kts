...
include(":instrumentation:thrift:thrift-0.7.0:javaagent")
include(":instrumentation:thrift:thrift-0.9.1:javaagent")
include(":instrumentation:thrift:thrift-common:library")
include(":instrumentation:thrift:thrift-0.9.0-testing")
include(":instrumentation:thrift:thrift-0.9.2-testing")
include(":instrumentation:thrift:thrift-0.9.3-testing")
include(":instrumentation:thrift:thrift-0.14.0-testing")
