...
include(":instrumentation:jaxws:jaxws-3.0:javaagent")
include(":instrumentation:jaxws:jaxws-3.0-common-testing")
include(":instrumentation:jaxws:jaxws-3.0-cxf-4.0:javaagent")
include(":instrumentation:jaxws:jaxws-3.0-cxf-4.0:javaagent-unit-tests")
