...
include(":instrumentation:reactor:reactor-3.1:bootstrap")
...
include(":instrumentation:spring:spring-ai:spring-ai-1.0:javaagent")
include(":instrumentation:spring:spring-ai:spring-ai-1.0:testing")
include(":instrumentation:spring:spring-ai:spring-ai-openai-1.0:javaagent")
include(":instrumentation:spring:spring-ai:spring-ai-openai-1.0:testing")
