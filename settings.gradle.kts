...
include(":instrumentation:rocketmq:rocketmq-client:rocketmq-client-java-5.0:javaagent")
include(":instrumentation:rocketmq:rocketmq-client:rocketmq-client-java-5.0:testing")
