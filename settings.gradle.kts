...
include(":instrumentation:ibmmq:ibmmq-9.0:javaagent")
include(":instrumentation:ibmmq:ibmmq-9.3:javaagent")
include(":instrumentation:ibmmq:ibmmq-common:javaagent")
