...
include(":instrumentation:cats-effect:cats-effect-3.6:bootstrap")
include(":instrumentation:cats-effect:cats-effect-3.6:javaagent")
include(":instrumentation:cats-effect:cats-effect-common-3.6:javaagent")
