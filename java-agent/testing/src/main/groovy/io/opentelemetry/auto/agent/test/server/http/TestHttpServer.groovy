package io.opentelemetry.auto.agent.test.server.http
...
import static io.opentelemetry.auto.agent.test.server.http.HttpServletRequestExtractAdapter.GETTER
