...
- Use `payara-5.2020` based on the smoke-test floor rather than the lower `OpenTracingService` class gate; the instrumentation is ASM-based and the repository's tested Payara floor is the better naming signal.
