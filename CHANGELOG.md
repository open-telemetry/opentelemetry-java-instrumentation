...
- Deprecate the Spring Boot starter `ConfigProperties` beans in favor of injecting `ConfigProvider`.
  The compatibility beans remain until 3.0 to give starter auto-configurations time to migrate.
