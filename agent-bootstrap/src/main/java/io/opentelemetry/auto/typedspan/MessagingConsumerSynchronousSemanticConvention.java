...
public interface MessagingConsumerSynchronousSemanticConvention {
   ...
   */
  MessagingConsumerSynchronousSemanticConvention setMessagingDestination(String messagingDestination);

  /**
   * Sets a value for messaging.destination_kind
   * @param messagingDestinationKind The kind of message destination.
   */
  MessagingConsumerSynchronousSemanticConvention setMessagingDestinationKind(String messagingDestinationKind);
   ...
   */
  MessagingConsumerSynchronousSemanticConvention setMessagingProtocolVersion(String messagingProtocolVersion);
   ...
   */
  MessagingConsumerSynchronousSemanticConvention setMessagingConversationId(String messagingConversationId);
   ...
   */
  MessagingConsumerSynchronousSemanticConvention setMessagingMessagePayloadSizeBytes(long messagingMessagePayloadSizeBytes);
   ...
   */
  MessagingConsumerSynchronousSemanticConvention setMessagingMessagePayloadCompressedSizeBytes(long messagingMessagePayloadCompressedSizeBytes);
