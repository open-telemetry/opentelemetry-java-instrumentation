...
public interface DbMysqlSemanticConvention {
   ...
   */
  DbMysqlSemanticConvention setDbSystem(String dbSystem);
   ...
   */
  DbMysqlSemanticConvention setDbConnectionString(String dbConnectionString);
   ...
   */
  DbMysqlSemanticConvention setDbUser(String dbUser);
   ...
   */
  DbMysqlSemanticConvention setDbName(String dbName);
   ...
   */
  DbMysqlSemanticConvention setDbStatement(String dbStatement);
   ...
   */
  DbMysqlSemanticConvention setDbOperation(String dbOperation);
   ...
   */
  DbMysqlSemanticConvention setNetPeerName(String netPeerName);
   ...
   */
  DbMysqlSemanticConvention setNetPeerIp(String netPeerIp);
   ...
   */
  DbMysqlSemanticConvention setNetPeerPort(long netPeerPort);
   ...
   */
  DbMysqlSemanticConvention setNetTransport(String netTransport);
   ...
   */
  DbMysqlSemanticConvention setDbMssqlInstanceName(String dbMssqlInstanceName);
}
