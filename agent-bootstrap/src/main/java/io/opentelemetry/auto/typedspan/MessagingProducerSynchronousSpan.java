...
public class MessagingProducerSynchronousSpan extends DelegatingSpan
  ...
  public static MessagingProducerSynchronousSpanBuilder createMessagingProducerSynchronousSpan(
    ...
    return new MessagingProducerSynchronousSpanBuilder(tracer, spanName).setKind(Kind.CLIENT);
  }
  ...
  public static class MessagingProducerSynchronousSpanBuilder {
    ...
    public MessagingProducerSynchronousSpanBuilder(Builder spanBuilder, long attributes) {
    ...
    public MessagingProducerSynchronousSpanBuilder setKind(Kind kind) {
