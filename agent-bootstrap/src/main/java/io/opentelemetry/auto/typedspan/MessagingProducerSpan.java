...
public class MessagingProducerSpan extends DelegatingSpan
  ...
  public static MessagingProducerSpanBuilder createMessagingProducerSpan(
    ...
    return new MessagingProducerSpanBuilder(tracer, spanName).setKind(Kind.PRODUCER);
  }
  ...
  public static class MessagingProducerSpanBuilder {
    ...
    public MessagingProducerSpanBuilder(Builder spanBuilder, long attributes) {
    ...
    public MessagingProducerSpanBuilder setKind(Kind kind) {
