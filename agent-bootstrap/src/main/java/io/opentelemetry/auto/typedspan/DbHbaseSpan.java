...
public class DbHbaseSpan extends DelegatingSpan implements DbHbaseSemanticConvention {
   ...
   */
  @Override
  public DbHbaseSemanticConvention setDbMssqlInstanceName(String dbMssqlInstanceName) {
  ...
  public static class DbHbaseSpanBuilder {
    ...
    public DbHbaseSpanBuilder(Builder spanBuilder, long attributes) {
    ...
    public DbHbaseSpanBuilder setKind(Kind kind) {
     ...
     */
    public DbHbaseSpanBuilder setDbMssqlInstanceName(String dbMssqlInstanceName) {
      status.set(AttributeStatus.DB_MSSQL_INSTANCE_NAME);
