...
public class DbMongodbSpan extends DelegatingSpan implements DbMongodbSemanticConvention {
  ...
  public static class DbMongodbSpanBuilder {
    ...
    public DbMongodbSpanBuilder(Builder spanBuilder, long attributes) {
    ...
    public DbMongodbSpanBuilder setKind(Kind kind) {
     ...
     */
    public DbMongodbSpanBuilder setDbMssqlInstanceName(String dbMssqlInstanceName) {
      status.set(AttributeStatus.DB_MSSQL_INSTANCE_NAME);
