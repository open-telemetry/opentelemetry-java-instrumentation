...
public interface MessagingProducerSynchronousSemanticConvention {
   ...
   */
  MessagingProducerSynchronousSemanticConvention setMessagingDestination(String messagingDestination);

  /**
   * Sets a value for messaging.destination_kind
   * @param messagingDestinationKind The kind of message destination.
   */
  MessagingProducerSynchronousSemanticConvention setMessagingDestinationKind(String messagingDestinationKind);
   ...
   */
  MessagingProducerSynchronousSemanticConvention setMessagingTempDestination(boolean messagingTempDestination);
   ...
   */
  MessagingProducerSynchronousSemanticConvention setMessagingProtocolVersion(String messagingProtocolVersion);
   ...
   */
  MessagingProducerSynchronousSemanticConvention setMessagingConversationId(String messagingConversationId);
   ...
   */
  MessagingProducerSynchronousSemanticConvention setMessagingMessagePayloadSizeBytes(long messagingMessagePayloadSizeBytes);
   ...
   */
  MessagingProducerSynchronousSemanticConvention setMessagingMessagePayloadCompressedSizeBytes(long messagingMessagePayloadCompressedSizeBytes);
