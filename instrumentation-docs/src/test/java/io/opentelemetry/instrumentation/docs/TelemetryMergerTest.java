...
class TelemetryMergerTest {
  ...
  void testOverrideMode() {
    ...
    Map<String, List<EmittedMetrics.Metric>> autoMetrics = createAutoGeneratedMetrics();
    Map<String, List<EmittedSpans.Span>> autoSpans = createAutoGeneratedSpans();
  ...
  private static Map<String, List<EmittedMetrics.Metric>> createAutoGeneratedMetrics() {
  ...
  private static Map<String, List<EmittedSpans.Span>> createAutoGeneratedSpans() {
