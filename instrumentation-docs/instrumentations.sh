...
readonly INSTRUMENTATIONS=(
  ...
  "vertx:vertx-http-client:vertx-kafka-client-3.6::vertx-kafka-client-3.6-testing:test"
  "vertx:vertx-http-client:vertx-kafka-client-3.6::vertx-kafka-client-3.6-testing:testExperimental"
