...
public abstract class AbstractSpringStarterSmokeTest {
  ...
  private static final List<String> IGNORED_WARNINGS =
      asList(
          ...
          "Registering converter from interface java.util.List to interface"
              + " org.springframework.data.domain.Vector as reading converter although it doesn't"
              + " convert from a store-supported type; You might want to check your annotation"
