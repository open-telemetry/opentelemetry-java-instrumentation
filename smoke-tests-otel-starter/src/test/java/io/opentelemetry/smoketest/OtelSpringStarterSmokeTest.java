...
@SpringBootTest(
    ...
    properties = {"otel.exporter.otlp.enabled=false", "otel.metric.export.interval=1"
      // We set the export interval of the metrics to 1 ms. The default value is 1 minute.
    })
