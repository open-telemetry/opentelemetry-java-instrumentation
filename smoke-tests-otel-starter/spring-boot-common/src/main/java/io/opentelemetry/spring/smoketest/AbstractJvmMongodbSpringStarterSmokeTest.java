...
public class AbstractJvmMongodbSpringStarterSmokeTest extends AbstractMongodbSpringStarterSmokeTest {
    ...
    void mongodb() {
      contextRunner.run(
          applicationContext -> {
            ...
            testRestTemplate = applicationContext.getBean(TestRestTemplate.class);
            super.mongodb();
          });
    }
}
